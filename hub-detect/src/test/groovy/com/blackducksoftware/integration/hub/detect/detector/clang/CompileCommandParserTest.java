...
public class CompileCommandParserTest {
    ...
    public void testGetCompilerArgsFromJsonFile() throws IOException {
        ...
        final List<CompileCommand> compileCommands = compileCommandDatabaseParser.parseCompileCommandDatabase(new File("src/test/resources/clang/compile_commands.json"));
