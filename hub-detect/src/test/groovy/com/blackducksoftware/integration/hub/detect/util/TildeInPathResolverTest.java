...
public class TildeInPathResolverTest {
    ...
    public void testResolvingTilde() throws IllegalArgumentException, IllegalAccessException {
        ...
        final Optional<String> resolved = resolver.resolveTildeInValue("~/Documents/source/integration/hub-detect");

        Assert.assertEquals("/Users/ekerwin/Documents/source/integration/hub-detect", resolved.get());
    }
