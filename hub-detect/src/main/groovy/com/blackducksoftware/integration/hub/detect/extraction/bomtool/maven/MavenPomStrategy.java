...
public class MavenPomStrategy extends Strategy {
    ...
    public MavenPomStrategy(final StrategyEnvironment environment, final DetectFileFinder fileFinder, final MavenExecutableFinder mavenExecutableFinder, final MavenCliExtractor mavenCliExtractor) {
        super(environment);
