...
public class ScanBatchRunnerFactory {
    ...
    public ScanBatchRunner withHubInstall(BlackDuckServerConfig hubServerConfig) {
        ...
        ScanBatchRunner scanBatchManager = ScanBatchRunner.createFullScanManager(slf4jIntLogger, intEnvironmentVariables, scannerZipInstaller, scanPathsUtility, scanCommandRunner);
    ...
    public ScanBatchRunner withoutInstall(File defaultInstallDirectory) {
        ...
        return ScanBatchRunner.createScanManagerWithNoInstaller(slf4jIntLogger, intEnvironmentVariables, defaultInstallDirectory, scanPathsUtility, scanCommandRunner);
    }
    ...
    public ScanBatchRunner withUserProvidedUrl(String userProvidedScannerInstallUrl, ConnectionManager connectionManager) throws DetectUserFriendlyException {
        ...
        return ScanBatchRunner.createFullScanManager(slf4jIntLogger, intEnvironmentVariables, scannerZipInstaller, scanPathsUtility, scanCommandRunner);
    }
