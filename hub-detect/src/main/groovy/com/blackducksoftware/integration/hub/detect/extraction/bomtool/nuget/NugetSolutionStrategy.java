...
public class NugetSolutionStrategy extends Strategy {
    ...
    public NugetSolutionStrategy(final StrategyEnvironment environment, final DetectFileFinder fileFinder, final NugetInspectorManager nugetInspectorManager, final NugetInspectorExtractor nugetInspectorExtractor) {
        super(environment);
    ...
    public StrategyType getStrategyType() {
        return StrategyType.NUGET_SOLUTION_INSPECTOR;
    }
