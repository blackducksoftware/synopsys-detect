...
public class NpmCliDependencyFinder {
    ...
    public NpmParseResult generateCodeLocation(final String sourcePath, final File npmLsOutputFile) throws IOException {
        ...
        return convertNpmJsonFileToCodeLocation(sourcePath, FileUtils.readFileToString(npmLsOutputFile, StandardCharsets.UTF_8));
    }

    private NpmParseResult convertNpmJsonFileToCodeLocation(final String sourcePath, final String npmLsOutput) {
        ...
        final DetectCodeLocation codeLocation = new DetectCodeLocation.Builder(BomToolGroupType.NPM, sourcePath, externalId, graph).build();
