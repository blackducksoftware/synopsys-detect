...
public class NpmPackageLockOnlyDetector extends Detector {
    ...
    public NpmPackageLockOnlyDetector(final DetectorEnvironment environment, final DetectFileFinder fileFinder, final NpmLockfileExtractor npmLockfileExtractor) {
        super(environment, "Package Lock Only", DetectorType.NPM);
