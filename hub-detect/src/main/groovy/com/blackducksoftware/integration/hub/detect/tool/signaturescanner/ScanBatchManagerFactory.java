...
public class ScanBatchManagerFactory {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private Slf4jIntLogger slf4jIntLogger = new Slf4jIntLogger(logger);

    public ScanBatchManager withHubInstall(HubServerConfig hubServerConfig, ExecutorService executorService, IntEnvironmentVariables intEnvironmentVariables) {
        ...
        ScanBatchManager scanBatchManager = ScanBatchManager.createFullScanManager(slf4jIntLogger, intEnvironmentVariables, scannerZipInstaller, scanPathsUtility, scanCommandRunner);
        return scanBatchManager;
    }

    public ScanBatchManager withoutInstall(File defaultInstallDirectory, ExecutorService executorService, IntEnvironmentVariables intEnvironmentVariables) {
        ...
        return ScanBatchManager.createScanManagerWithNoInstaller(slf4jIntLogger, intEnvironmentVariables, defaultInstallDirectory, scanPathsUtility, scanCommandRunner);
    }
