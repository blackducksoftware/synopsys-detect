 ...
 * under the License.
 */
package com.blackducksoftware.integration.hub.detect.extraction.bomtool.sbt.parse
...
import com.blackducksoftware.integration.hub.detect.extraction.bomtool.sbt.reports.parse.SbtReportParser
...
class SbtPackager {
    ...
    SbtProject extractProject(String path, int depth, String included, String excluded) {
        ...
        result.bomToolType = BomToolType.SBT
