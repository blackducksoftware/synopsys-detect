...
public class StrategyEnvironment {
    ...
    private final Set<StrategyType> appliedToParent;
    private final int depth;
    private final ExcludedIncludedFilter bomToolFilter;
    private final boolean forceNestedSearch;

    public StrategyEnvironment(final File directory, final Set<StrategyType> appliedToParent, final int depth, final ExcludedIncludedFilter bomToolFilter, final boolean forceNestedSearch) {
    ...
    public Set<StrategyType> getAppliedToParent() {
