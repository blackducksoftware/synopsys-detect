...
public class HubServiceWrapper {
    ...
    public HubServiceWrapper(final DetectConfigWrapper detectConfigWrapper, final AdditionalPropertyConfig additionalPropertyConfig, Gson gson, JsonParser jsonParser) {
