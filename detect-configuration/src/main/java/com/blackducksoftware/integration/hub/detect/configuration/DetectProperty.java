...
public enum DetectProperty {
    ...
    DETECT_FORCE_SUCCESS("detect.force.success", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_SUPPRESS_CONFIGURATION_OUTPUT("detect.suppress.configuration.output", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_LOGGING)
    @HelpDescription("If true, the default behavior of printing the Detect Results will be suppressed.")
    DETECT_SUPPRESS_RESULTS_OUTPUT("detect.suppress.results.output", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_CLEANUP)
    @HelpDescription("If true the files created by Detect will be cleaned up.")
    DETECT_CLEANUP("detect.cleanup", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_TEST_CONNECTION("detect.test.connection", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_API_TIMEOUT("detect.api.timeout", PropertyType.LONG, "300000"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.url in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB })
    @HelpDescription("URL of the Hub server")
    BLACKDUCK_HUB_URL("blackduck.hub.url", PropertyType.STRING),
    ...
    BLACKDUCK_URL("blackduck.url", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.timeout in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB })
    @HelpDescription("Time to wait for rest connections to complete")
    BLACKDUCK_HUB_TIMEOUT("blackduck.hub.timeout", PropertyType.INTEGER, "120"),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Time to wait for rest connections to complete")
    BLACKDUCK_TIMEOUT("blackduck.timeout", PropertyType.INTEGER, "120"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.username in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB })
    @HelpDescription("Hub username")
    BLACKDUCK_HUB_USERNAME("blackduck.hub.username", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Black Duck username")
    BLACKDUCK_USERNAME("blackduck.username", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.password in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB })
    @HelpDescription("Hub password")
    BLACKDUCK_HUB_PASSWORD("blackduck.hub.password", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Black Duck password")
    BLACKDUCK_PASSWORD("blackduck.password", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.api.token in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB })
    @HelpDescription("Hub API Token")
    BLACKDUCK_HUB_API_TOKEN("blackduck.hub.api.token", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Black Duck API Token")
    BLACKDUCK_API_TOKEN("blackduck.api.token", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.proxy.host in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy host")
    BLACKDUCK_HUB_PROXY_HOST("blackduck.hub.proxy.host", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy host")
    BLACKDUCK_PROXY_HOST("blackduck.proxy.host", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.proxy.port in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy port")
    BLACKDUCK_HUB_PROXY_PORT("blackduck.hub.proxy.port", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy port")
    BLACKDUCK_PROXY_PORT("blackduck.proxy.port", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.proxy.username in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy username")
    BLACKDUCK_HUB_PROXY_USERNAME("blackduck.hub.proxy.username", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy username")
    BLACKDUCK_PROXY_USERNAME("blackduck.proxy.username", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.proxy.password in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy password")
    BLACKDUCK_HUB_PROXY_PASSWORD("blackduck.hub.proxy.password", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy password")
    BLACKDUCK_PROXY_PASSWORD("blackduck.proxy.password", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.proxy.ntlm.domain in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB, SEARCH_GROUP_PROXY })
    @HelpDescription("Ntlm Proxy domain")
    BLACKDUCK_HUB_PROXY_NTLM_DOMAIN("blackduck.hub.proxy.ntlm.domain", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Ntlm Proxy domain")
    BLACKDUCK_PROXY_NTLM_DOMAIN("blackduck.proxy.ntlm.domain", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.proxy.ignored.hosts in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB, SEARCH_GROUP_PROXY })
    @HelpDescription("Comma separated list of host patterns that should not use the proxy")
    BLACKDUCK_HUB_PROXY_IGNORED_HOSTS("blackduck.hub.proxy.ignored.hosts", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Comma separated list of host patterns that should not use the proxy")
    BLACKDUCK_PROXY_IGNORED_HOSTS("blackduck.proxy.ignored.hosts", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.proxy.ntlm.workstation in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB, SEARCH_GROUP_PROXY })
    @HelpDescription("Ntlm Proxy workstation")
    BLACKDUCK_HUB_PROXY_NTLM_WORKSTATION("blackduck.hub.proxy.ntlm.workstation", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Ntlm Proxy workstation")
    BLACKDUCK_PROXY_NTLM_WORKSTATION("blackduck.proxy.ntlm.workstation", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.trust.cert in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB })
    @HelpDescription("If true, automatically trust the certificate for the current run of Detect only")
    BLACKDUCK_HUB_TRUST_CERT("blackduck.hub.trust.cert", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("If true, automatically trust the certificate for the current run of Detect only")
    BLACKDUCK_TRUST_CERT("blackduck.trust.cert", PropertyType.BOOLEAN, "false"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --blackduck.offline.mode in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    ...
    BLACKDUCK_HUB_OFFLINE_MODE("blackduck.hub.offline.mode", PropertyType.BOOLEAN, "false"),
    ...
    BLACKDUCK_OFFLINE_MODE("blackduck.offline.mode", PropertyType.BOOLEAN, "false"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.disable.without.blackduck in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_HUB_CONFIGURATION, additional = { SEARCH_GROUP_HUB })
    ...
    DETECT_DISABLE_WITHOUT_HUB("detect.disable.without.hub", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_DISABLE_WITHOUT_BLACKDUCK("detect.disable.without.blackduck", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_RESOLVE_TILDE_IN_PATHS("detect.resolve.tilde.in.paths", PropertyType.BOOLEAN, "true"),

    @HelpGroup(primary = GROUP_PATHS)
    @HelpDescription("Source path to inspect")
    DETECT_SOURCE_PATH("detect.source.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PATHS)
    @HelpDescription("Output path")
    DETECT_OUTPUT_PATH("detect.output.path", PropertyType.STRING),
    ...
    DETECT_BDIO_OUTPUT_PATH("detect.bdio.output.path", PropertyType.STRING),
    ...
    DETECT_SCAN_OUTPUT_PATH("detect.scan.output.path", PropertyType.STRING),
    ...
    DETECT_SBT_REPORT_DEPTH("detect.sbt.report.search.depth", PropertyType.INTEGER, "3"),
    ...
    DETECT_BOM_TOOL_SEARCH_DEPTH("detect.bom.tool.search.depth", PropertyType.INTEGER, "0"),
    ...
    DETECT_REQUIRED_BOM_TOOL_TYPES("detect.required.bom.tool.types", PropertyType.STRING),
    ...
    DETECT_BOM_TOOL_SEARCH_CONTINUE("detect.bom.tool.search.continue", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PATHS, additional = { GROUP_BOMTOOL, SEARCH_GROUP_SEARCH })
    @HelpDescription("A comma-separated list of directory names to exclude from the bom tool search.")
    DETECT_BOM_TOOL_SEARCH_EXCLUSION("detect.bom.tool.search.exclusion", PropertyType.STRING_ARRAY),
    ...
    DETECT_BOM_TOOL_SEARCH_EXCLUSION_DEFAULTS("detect.bom.tool.search.exclusion.defaults", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_EXCLUDED_BOM_TOOL_TYPES("detect.excluded.bom.tool.types", PropertyType.STRING),
    ...
    DETECT_INCLUDED_BOM_TOOL_TYPES("detect.included.bom.tool.types", PropertyType.STRING),
    ...
    DETECT_CODE_LOCATION_NAME("detect.code.location.name", PropertyType.STRING),
    ...
    DETECT_PROJECT_NAME("detect.project.name", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("If project description is specified, your project version will be created with this description.")
    DETECT_PROJECT_DESCRIPTION("detect.project.description", PropertyType.STRING),
    ...
    DETECT_PROJECT_VERSION_NAME("detect.project.version.name", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("If project version notes are specified, your project version will be created with these notes.")
    DETECT_PROJECT_VERSION_NOTES("detect.project.version.notes", PropertyType.STRING),
    ...
    DETECT_PROJECT_TIER("detect.project.tier", PropertyType.INTEGER),
    ...
    DETECT_PROJECT_CODELOCATION_PREFIX("detect.project.codelocation.prefix", PropertyType.STRING, ""),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("A suffix to the name of the codelocations created by Detect.")
    DETECT_PROJECT_CODELOCATION_SUFFIX("detect.project.codelocation.suffix", PropertyType.STRING, ""),
    ...
    DETECT_PROJECT_CODELOCATION_UNMAP("detect.project.codelocation.unmap", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("An override for the Project level matches.")
    DETECT_PROJECT_LEVEL_ADJUSTMENTS("detect.project.level.adjustments", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_PROJECT_VERSION_PHASE("detect.project.version.phase", PropertyType.STRING, "Development"),
    ...
    DETECT_PROJECT_CLONE_CATEGORIES("detect.project.clone.categories", PropertyType.STRING_ARRAY, "COMPONENT_DATA,VULN_DATA"),
    ...
    DETECT_CLONE_PROJECT_VERSION_NAME("detect.clone.project.version.name", PropertyType.STRING),
    ...
    DETECT_PROJECT_VERSION_DISTRIBUTION("detect.project.version.distribution", PropertyType.STRING, "External"),
    ...
    DETECT_PROJECT_VERSION_UPDATE("detect.project.version.update", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_POLICY_CHECK_FAIL_ON_SEVERITIES("detect.policy.check.fail.on.severities", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("Version of the Gradle Inspector")
    DETECT_GRADLE_INSPECTOR_VERSION("detect.gradle.inspector.version", PropertyType.STRING, "latest"),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("Gradle build command")
    DETECT_GRADLE_BUILD_COMMAND("detect.gradle.build.command", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the dependency configurations to exclude")
    DETECT_GRADLE_EXCLUDED_CONFIGURATIONS("detect.gradle.excluded.configurations", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the dependency configurations to include")
    DETECT_GRADLE_INCLUDED_CONFIGURATIONS("detect.gradle.included.configurations", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the projects to exclude")
    DETECT_GRADLE_EXCLUDED_PROJECTS("detect.gradle.excluded.projects", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the projects to include")
    DETECT_GRADLE_INCLUDED_PROJECTS("detect.gradle.included.projects", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The path to the Nuget.Config file to supply to the nuget exe")
    DETECT_NUGET_CONFIG_PATH("detect.nuget.config.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("Name of the Nuget Inspector")
    DETECT_NUGET_INSPECTOR_NAME("detect.nuget.inspector.name", PropertyType.STRING, "IntegrationNugetInspector"),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("Version of the Nuget Inspector")
    DETECT_NUGET_INSPECTOR_VERSION("detect.nuget.inspector.version", PropertyType.STRING, "latest"),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The names of the projects in a solution to exclude")
    DETECT_NUGET_EXCLUDED_MODULES("detect.nuget.excluded.modules", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The names of the projects in a solution to include (overrides exclude)")
    DETECT_NUGET_INCLUDED_MODULES("detect.nuget.included.modules", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("If true errors will be logged and then ignored.")
    DETECT_NUGET_IGNORE_FAILURE("detect.nuget.ignore.failure", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The name of the dependency scope to include")
    DETECT_MAVEN_SCOPE("detect.maven.scope", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("Maven build command")
    DETECT_MAVEN_BUILD_COMMAND("detect.maven.build.command", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("Path of the Gradle executable")
    DETECT_GRADLE_PATH("detect.gradle.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The path of the Maven executable")
    DETECT_MAVEN_PATH("detect.maven.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The names of the module to exclude")
    DETECT_MAVEN_EXCLUDED_MODULES("detect.maven.excluded.modules", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The names of the module to include")
    DETECT_MAVEN_INCLUDED_MODULES("detect.maven.included.modules", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The path of the Nuget executable")
    DETECT_NUGET_PATH("detect.nuget.path", PropertyType.STRING),
    ...
    DETECT_PIP_PROJECT_NAME("detect.pip.project.name", PropertyType.STRING),
    ...
    DETECT_PIP_PROJECT_VERSION_NAME("detect.pip.project.version.name", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PYTHON)
    @HelpDescription("If true will use Python 3 if available on class path")
    DETECT_PYTHON_PYTHON3("detect.python.python3", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PYTHON)
    @HelpDescription("The path of the Python executable")
    DETECT_PYTHON_PATH("detect.python.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PIP)
    @HelpDescription("The path of the Pipenv executable")
    DETECT_PIPENV_PATH("detect.pipenv.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NPM)
    @HelpDescription("A space-separated list of additional configuration to use when running Detect against an NPM project")
    DETECT_NPM_ARGUMENTS("detect.npm.configuration", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NPM)
    @HelpDescription("The path of the Npm executable")
    DETECT_NPM_PATH("detect.npm.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NPM)
    @HelpDescription("Set this value to false if you would like to exclude your dev dependencies when ran")
    DETECT_NPM_INCLUDE_DEV_DEPENDENCIES("detect.npm.include.dev.dependencies", PropertyType.BOOLEAN, "true"),

    @HelpGroup(primary = GROUP_NPM)
    @HelpDescription("The path of the node executable that is used by Npm")
    DETECT_NPM_NODE_PATH("detect.npm.node.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PEAR)
    @HelpDescription("The path of the pear executable")
    DETECT_PEAR_PATH("detect.pear.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PEAR)
    @HelpDescription("Set to true if you would like to include only required packages")
    DETECT_PEAR_ONLY_REQUIRED_DEPS("detect.pear.only.required.deps", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PIP)
    @HelpDescription("The path of the requirements.txt file")
    DETECT_PIP_REQUIREMENTS_PATH("detect.pip.requirements.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GO)
    @HelpDescription("Path of the Go Dep executable")
    DETECT_GO_DEP_PATH("detect.go.dep.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GO)
    @HelpDescription("If set to true, we will attempt to run 'init' and 'ensure' which can modify your development environment.")
    DETECT_GO_RUN_DEP_INIT("detect.go.run.dep.init", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("Path of the docker executable")
    DETECT_DOCKER_PATH("detect.docker.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("If set to false, detect will attempt to run docker even if it cannot find a docker path.")
    DETECT_DOCKER_PATH_REQUIRED("detect.docker.path.required", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_DOCKER_INSPECTOR_PATH("detect.docker.inspector.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("Version of the Docker Inspector to use")
    DETECT_DOCKER_INSPECTOR_VERSION("detect.docker.inspector.version", PropertyType.STRING, "latest"),
    ...
    DETECT_DOCKER_TAR("detect.docker.tar", PropertyType.STRING),
    ...
    DETECT_DOCKER_IMAGE("detect.docker.image", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PATHS)
    @HelpDescription("Path of the bash executable")
    DETECT_BASH_PATH("detect.bash.path", PropertyType.STRING),
    ...
    LOGGING_LEVEL_COM_BLACKDUCKSOFTWARE_INTEGRATION("logging.level.com.blackducksoftware.integration", PropertyType.STRING, "INFO"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.dry.run in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    ...
    DETECT_HUB_SIGNATURE_SCANNER_DRY_RUN("detect.hub.signature.scanner.dry.run", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_DRY_RUN("detect.blackduck.signature.scanner.dry.run", PropertyType.BOOLEAN, "false"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.snippet.mode in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    @HelpDescription("If set to true, the signature scanner will, if supported by your Hub version, run in snippet scanning mode.")
    DETECT_HUB_SIGNATURE_SCANNER_SNIPPET_MODE("detect.hub.signature.scanner.snippet.mode", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MODE("detect.blackduck.signature.scanner.snippet.mode", PropertyType.BOOLEAN, "false"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.exclusion.patterns in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    @HelpDescription("Enables you to specify sub-directories to exclude from scans")
    DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_PATTERNS("detect.hub.signature.scanner.exclusion.patterns", PropertyType.STRING_ARRAY),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Enables you to specify sub-directories to exclude from scans")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERNS("detect.blackduck.signature.scanner.exclusion.patterns", PropertyType.STRING_ARRAY),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.paths in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    @HelpDescription("These paths and only these paths will be scanned.")
    DETECT_HUB_SIGNATURE_SCANNER_PATHS("detect.hub.signature.scanner.paths", PropertyType.STRING_ARRAY),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("These paths and only these paths will be scanned.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_PATHS("detect.blackduck.signature.scanner.paths", PropertyType.STRING_ARRAY),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.exclusion.name.patterns in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    ...
    DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS("detect.hub.signature.scanner.exclusion.name.patterns", PropertyType.STRING_ARRAY, "node_modules"),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Comma separated list of file name patterns to exclude from the signature scan.")
    @HelpDetailed("Detect will recursively search within the scan targets for files/directories that match these file name patterns and will create the corresponding exclusion patterns for the signature scanner.\r\nThese patterns will be added to the patterns provided by detect.hub.signature.scanner.exclusion.patterns")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS("detect.blackduck.signature.scanner.exclusion.name.patterns", PropertyType.STRING_ARRAY, "node_modules"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.memory in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    @HelpDescription("The memory for the scanner to use.")
    DETECT_HUB_SIGNATURE_SCANNER_MEMORY("detect.hub.signature.scanner.memory", PropertyType.INTEGER, "4096"),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("The memory for the scanner to use.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_MEMORY("detect.blackduck.signature.scanner.memory", PropertyType.INTEGER, "4096"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.disabled in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    ...
    DETECT_HUB_SIGNATURE_SCANNER_DISABLED("detect.hub.signature.scanner.disabled", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_DISABLED("detect.blackduck.signature.scanner.disabled", PropertyType.BOOLEAN, "false"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.offline.local.path in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    ...
    DETECT_HUB_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH("detect.hub.signature.scanner.offline.local.path", PropertyType.STRING),
    ...
    @HelpDescription("To use a local signature scanner and force offline, specify the path where the signature scanner was unzipped. This will likely look similar to 'scan.cli-x.y.z' and includes the 'bin, icon, jre, and lib' directories of the expanded scan.cli.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH("detect.blackduck.signature.scanner.offline.local.path", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.local.path in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_OFFLINE, SEARCH_GROUP_HUB })
    ...
    DETECT_HUB_SIGNATURE_SCANNER_LOCAL_PATH("detect.hub.signature.scanner.local.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_OFFLINE, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("To use a local signature scanner, specify the path where the signature scanner was unzipped. This will likely look similar to 'scan.cli-x.y.z' and includes the 'bin, icon, jre, and lib' directories of the expanded scan.cli.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_LOCAL_PATH("detect.blackduck.signature.scanner.local.path", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.host.url in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    ...
    DETECT_HUB_SIGNATURE_SCANNER_HOST_URL("detect.hub.signature.scanner.host.url", PropertyType.STRING),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_HOST_URL("detect.blackduck.signature.scanner.host.url", PropertyType.STRING),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.parallel.processors in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    ...
    DETECT_HUB_SIGNATURE_SCANNER_PARALLEL_PROCESSORS("detect.hub.signature.scanner.parallel.processors", PropertyType.INTEGER, "1"),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("The number of scans to run in parallel, defaults to 1, but if you specify -1, the number of processors on the machine will be used.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_PARALLEL_PROCESSORS("detect.blackduck.signature.scanner.parallel.processors", PropertyType.INTEGER, "1"),

    @Deprecated
    @DetectDeprecation(description = "This property is changing. Please use --detect.blackduck.signature.scanner.configuration in the future.", failInVersion = DetectMajorVersion.FIVE, removeInVersion = DetectMajorVersion.SIX)
    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_HUB })
    @HelpDescription("Additional configuration to use when running the Hub signature scanner.")
    DETECT_HUB_SIGNATURE_SCANNER_ARGUMENTS("detect.hub.signature.scanner.configuration", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Additional configuration to use when running the Black Duck signature scanner.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_ARGUMENTS("detect.blackduck.signature.scanner.configuration", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("The path of a binary file to scan.")
    DETECT_BINARY_SCAN_FILE("detect.binary.scan.file.path", PropertyType.STRING),
    ...
    DETECT_PACKAGIST_INCLUDE_DEV_DEPENDENCIES("detect.packagist.include.dev.dependencies", PropertyType.BOOLEAN, "true"),

    @HelpGroup(primary = GROUP_CPAN)
    @HelpDescription("The path of the perl executable")
    DETECT_PERL_PATH("detect.perl.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_CPAN)
    @HelpDescription("The path of the cpan executable")
    DETECT_CPAN_PATH("detect.cpan.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_CPAN)
    @HelpDescription("The path of the cpanm executable")
    DETECT_CPANM_PATH("detect.cpanm.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SBT)
    @HelpDescription("The names of the sbt configurations to exclude")
    DETECT_SBT_EXCLUDED_CONFIGURATIONS("detect.sbt.excluded.configurations", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SBT)
    @HelpDescription("The names of the sbt configurations to include")
    DETECT_SBT_INCLUDED_CONFIGURATIONS("detect.sbt.included.configurations", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The scheme to use when the package managers can not determine a version, either 'text' or 'timestamp'")
    DETECT_DEFAULT_PROJECT_VERSION_SCHEME("detect.default.project.version.scheme", PropertyType.STRING, "text"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The text to use as the default project version")
    DETECT_DEFAULT_PROJECT_VERSION_TEXT("detect.default.project.version.text", PropertyType.STRING, "Default Detect Version"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The timestamp format to use as the default project version")
    DETECT_DEFAULT_PROJECT_VERSION_TIMEFORMAT("detect.default.project.version.timeformat", PropertyType.STRING, "yyyy-MM-dd\\'T\\'HH:mm:ss.SSS"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("If set, this will aggregate all the BOMs to create a single BDIO file with the name provided.")
    DETECT_BOM_AGGREGATE_NAME("detect.bom.aggregate.name", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("When set to true, a Black Duck risk report in PDF form will be created")
    DETECT_RISK_REPORT_PDF("detect.risk.report.pdf", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The output directory for risk report in PDF. Default is the source directory")
    DETECT_RISK_REPORT_PDF_PATH("detect.risk.report.pdf.path", PropertyType.STRING, "."),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("When set to true, a Black Duck notices report in text form will be created in your source directory")
    DETECT_NOTICES_REPORT("detect.notices.report", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The output directory for notices report. Default is the source directory")
    DETECT_NOTICES_REPORT_PATH("detect.notices.report.path", PropertyType.STRING, "."),

    @HelpGroup(primary = GROUP_CONDA)
    @HelpDescription("The path of the conda executable")
    DETECT_CONDA_PATH("detect.conda.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_CONDA)
    @HelpDescription("The name of the anaconda environment used by your project")
    DETECT_CONDA_ENVIRONMENT_NAME("detect.conda.environment.name", PropertyType.STRING),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("The path to the directory containing the docker inspector script, jar, and images")
    DETECT_DOCKER_INSPECTOR_AIR_GAP_PATH("detect.docker.inspector.air.gap.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The path to the directory containing the air gap dependencies for the gradle inspector")
    DETECT_GRADLE_INSPECTOR_AIR_GAP_PATH("detect.gradle.inspector.air.gap.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The path to the directory containing the nuget inspector nupkg")
    DETECT_NUGET_INSPECTOR_AIR_GAP_PATH("detect.nuget.inspector.air.gap.path", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The source for nuget packages")
    DETECT_NUGET_PACKAGES_REPO_URL("detect.nuget.packages.repo.url", PropertyType.STRING_ARRAY, "https://www.nuget.org/api/v2/"),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The respository gradle should use to look for the gradle inspector")
    DETECT_GRADLE_INSPECTOR_REPOSITORY_URL("detect.gradle.inspector.repository.url", PropertyType.STRING),

    @HelpGroup(primary = GROUP_HEX)
    @HelpDescription("The path of the rebar3 executable")
    DETECT_HEX_REBAR3_PATH("detect.hex.rebar3.path", PropertyType.STRING),

    @HelpDescription("The path of the Yarn executable")
    @HelpGroup(primary = GROUP_YARN)
    DETECT_YARN_PATH("detect.yarn.path", PropertyType.STRING),

    @HelpDescription("Set this to true to only scan production dependencies")
    @HelpGroup(primary = GROUP_YARN)
    DETECT_YARN_PROD_ONLY("detect.yarn.prod.only", PropertyType.BOOLEAN, "false");

    private final String propertyName;
    private final PropertyType propertyType;
    private final String defaultValue;

    DetectProperty(final String propertyName, final PropertyType propertyType) {
        this.propertyName = propertyName;
        this.propertyType = propertyType;
        this.defaultValue = null;
    }

    DetectProperty(final String propertyName, final PropertyType propertyType, final String defaultValue) {
        this.propertyName = propertyName;
        this.propertyType = propertyType;
