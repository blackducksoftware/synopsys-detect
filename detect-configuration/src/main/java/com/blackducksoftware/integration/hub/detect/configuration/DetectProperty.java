...
public enum DetectProperty {
    ...
    DETECT_DOCKER_INSPECTOR_VERSION("detect.docker.inspector.version", "3.0.0", PropertyType.STRING, PropertyAuthority.None, "6.*"),
    ...
    DETECT_BITBAKE_PACKAGE_NAME("detect.bitbake.package.name", "4.4.0", PropertyType.STRING, PropertyAuthority.None),
