...
public enum DetectProperty {
    ...
    DETECT_FORCE_SUCCESS("detect.force.success", "3.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_SUPPRESS_CONFIGURATION_OUTPUT("detect.suppress.configuration.output", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_LOGGING)
    @HelpDescription("If true, the default behavior of printing the Detect Results will be suppressed.")
    DETECT_SUPPRESS_RESULTS_OUTPUT("detect.suppress.results.output", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_CLEANUP)
    @HelpDescription("If true the files created by Detect will be cleaned up.")
    DETECT_CLEANUP("detect.cleanup", "3.2.0", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_TEST_CONNECTION("detect.test.connection", "3.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_API_TIMEOUT("detect.api.timeout", "3.0.0", PropertyType.LONG, "300000"),
    ...
    BLACKDUCK_HUB_URL("blackduck.hub.url", "3.0.0", PropertyType.STRING),
    ...
    BLACKDUCK_URL("blackduck.url", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_TIMEOUT("blackduck.hub.timeout", "3.0.0", PropertyType.INTEGER, "120"),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Time to wait for rest connections to complete")
    BLACKDUCK_TIMEOUT("blackduck.timeout", "4.2.0", PropertyType.INTEGER, "120"),
    ...
    BLACKDUCK_HUB_USERNAME("blackduck.hub.username", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Black Duck username")
    BLACKDUCK_USERNAME("blackduck.username", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PASSWORD("blackduck.hub.password", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Black Duck password")
    BLACKDUCK_PASSWORD("blackduck.password", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_API_TOKEN("blackduck.hub.api.token", "3.1.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Black Duck API Token")
    BLACKDUCK_API_TOKEN("blackduck.api.token", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PROXY_HOST("blackduck.hub.proxy.host", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy host")
    BLACKDUCK_PROXY_HOST("blackduck.proxy.host", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PROXY_PORT("blackduck.hub.proxy.port", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy port")
    BLACKDUCK_PROXY_PORT("blackduck.proxy.port", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PROXY_USERNAME("blackduck.hub.proxy.username", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy username")
    BLACKDUCK_PROXY_USERNAME("blackduck.proxy.username", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PROXY_PASSWORD("blackduck.hub.proxy.password", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Proxy password")
    BLACKDUCK_PROXY_PASSWORD("blackduck.proxy.password", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PROXY_NTLM_DOMAIN("blackduck.hub.proxy.ntlm.domain", "3.1.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Ntlm Proxy domain")
    BLACKDUCK_PROXY_NTLM_DOMAIN("blackduck.proxy.ntlm.domain", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PROXY_IGNORED_HOSTS("blackduck.hub.proxy.ignored.hosts", "3.2.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Comma separated list of host patterns that should not use the proxy")
    BLACKDUCK_PROXY_IGNORED_HOSTS("blackduck.proxy.ignored.hosts", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_PROXY_NTLM_WORKSTATION("blackduck.hub.proxy.ntlm.workstation", "3.1.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK, SEARCH_GROUP_PROXY })
    @HelpDescription("Ntlm Proxy workstation")
    BLACKDUCK_PROXY_NTLM_WORKSTATION("blackduck.proxy.ntlm.workstation", "4.2.0", PropertyType.STRING),
    ...
    BLACKDUCK_HUB_TRUST_CERT("blackduck.hub.trust.cert", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_BLACKDUCK_CONFIGURATION, additional = { SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("If true, automatically trust the certificate for the current run of Detect only")
    BLACKDUCK_TRUST_CERT("blackduck.trust.cert", "4.2.0", PropertyType.BOOLEAN, "false"),
    ...
    BLACKDUCK_HUB_OFFLINE_MODE("blackduck.hub.offline.mode", "3.0.0", PropertyType.BOOLEAN, "false"),
    ...
    BLACKDUCK_OFFLINE_MODE("blackduck.offline.mode", "4.2.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_DISABLE_WITHOUT_HUB("detect.disable.without.hub", "4.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_DISABLE_WITHOUT_BLACKDUCK("detect.disable.without.blackduck", "4.2.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_RESOLVE_TILDE_IN_PATHS("detect.resolve.tilde.in.paths", "3.0.0", PropertyType.BOOLEAN, "true"),

    @HelpGroup(primary = GROUP_PATHS)
    @HelpDescription("Source path to inspect")
    DETECT_SOURCE_PATH("detect.source.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PATHS)
    @HelpDescription("Output path")
    DETECT_OUTPUT_PATH("detect.output.path", "3.0.0", PropertyType.STRING),
    ...
    DETECT_BDIO_OUTPUT_PATH("detect.bdio.output.path", "3.0.0", PropertyType.STRING),
    ...
    DETECT_SCAN_OUTPUT_PATH("detect.scan.output.path", "3.0.0", PropertyType.STRING),
    ...
    DETECT_SBT_REPORT_DEPTH("detect.sbt.report.search.depth", "4.3.0", PropertyType.INTEGER, "3"),
    ...
    DETECT_SEARCH_DEPTH("detect.search.depth", "3.0.0", PropertyType.INTEGER, "3"),
    ...
    DETECT_PROJECT_BOM_TOOL("detect.project.bom.tool", "4.0.0", PropertyType.STRING),

    //DETECT_BOM_TOOLS_DISABLED

    @HelpGroup(primary = GROUP_PATHS, additional = { GROUP_BOMTOOL, SEARCH_GROUP_SEARCH })
    @HelpDescription("Depth from source paths to search for files to determine if a bom tool applies.")
    DETECT_BOM_TOOL_SEARCH_DEPTH("detect.bom.tool.search.depth", "3.2.0", PropertyType.INTEGER, "0"),
    ...
    DETECT_REQUIRED_BOM_TOOL_TYPES("detect.required.bom.tool.types", "4.3.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_BOMTOOL, additional = { GROUP_BOMTOOL })
    @HelpDescription("If true, detect will not perform any bom tool work.")
    DETECT_BOM_TOOLS_DISABLED("detect.bom.tools.disabled", "5.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_BOM_TOOL_SEARCH_CONTINUE("detect.bom.tool.search.continue", "3.2.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PATHS, additional = { GROUP_BOMTOOL, SEARCH_GROUP_SEARCH })
    @HelpDescription("A comma-separated list of directory names to exclude from the bom tool search.")
    DETECT_BOM_TOOL_SEARCH_EXCLUSION("detect.bom.tool.search.exclusion", "3.2.0", PropertyType.STRING_ARRAY),
    ...
    DETECT_BOM_TOOL_SEARCH_EXCLUSION_DEFAULTS("detect.bom.tool.search.exclusion.defaults", "3.2.0", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_EXCLUDED_BOM_TOOL_TYPES("detect.excluded.bom.tool.types", "3.0.0", PropertyType.STRING),
    ...
    DETECT_INCLUDED_BOM_TOOL_TYPES("detect.included.bom.tool.types", "3.0.0", PropertyType.STRING),
    ...
    DETECT_CODE_LOCATION_NAME("detect.code.location.name", "4.0.0", PropertyType.STRING),
    ...
    DETECT_PROJECT_NAME("detect.project.name", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("If project description is specified, your project version will be created with this description.")
    DETECT_PROJECT_DESCRIPTION("detect.project.description", "4.0.0", PropertyType.STRING),
    ...
    DETECT_PROJECT_VERSION_NAME("detect.project.version.name", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("If project version notes are specified, your project version will be created with these notes.")
    DETECT_PROJECT_VERSION_NOTES("detect.project.version.notes", "3.1.0", PropertyType.STRING),
    ...
    DETECT_PROJECT_TIER("detect.project.tier", "3.1.0", PropertyType.INTEGER),
    ...
    DETECT_PROJECT_CODELOCATION_PREFIX("detect.project.codelocation.prefix", "3.0.0", PropertyType.STRING, ""),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("A suffix to the name of the codelocations created by Detect.")
    DETECT_PROJECT_CODELOCATION_SUFFIX("detect.project.codelocation.suffix", "3.0.0", PropertyType.STRING, ""),
    ...
    DETECT_PROJECT_CODELOCATION_UNMAP("detect.project.codelocation.unmap", "4.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("An override for the Project level matches.")
    DETECT_PROJECT_LEVEL_ADJUSTMENTS("detect.project.level.adjustments", "3.0.0", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_PROJECT_VERSION_PHASE("detect.project.version.phase", "3.0.0", PropertyType.STRING, "Development"),
    ...
    DETECT_PROJECT_CLONE_CATEGORIES("detect.project.clone.categories", "4.2.0", PropertyType.STRING_ARRAY, "COMPONENT_DATA,VULN_DATA"),
    ...
    DETECT_CLONE_PROJECT_VERSION_NAME("detect.clone.project.version.name", "4.2.0", PropertyType.STRING),
    ...
    DETECT_PROJECT_VERSION_DISTRIBUTION("detect.project.version.distribution", "3.0.0", PropertyType.STRING, "External"),
    ...
    DETECT_PROJECT_VERSION_UPDATE("detect.project.version.update", "4.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_POLICY_CHECK_FAIL_ON_SEVERITIES("detect.policy.check.fail.on.severities", "3.0.0", PropertyType.STRING),
    ...
    DETECT_GRADLE_INSPECTOR_VERSION("detect.gradle.inspector.version", "3.0.0", PropertyType.STRING, "0.*"),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("Gradle build command")
    DETECT_GRADLE_BUILD_COMMAND("detect.gradle.build.command", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the dependency configurations to exclude")
    DETECT_GRADLE_EXCLUDED_CONFIGURATIONS("detect.gradle.excluded.configurations", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the dependency configurations to include")
    DETECT_GRADLE_INCLUDED_CONFIGURATIONS("detect.gradle.included.configurations", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the projects to exclude")
    DETECT_GRADLE_EXCLUDED_PROJECTS("detect.gradle.excluded.projects", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The names of the projects to include")
    DETECT_GRADLE_INCLUDED_PROJECTS("detect.gradle.included.projects", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The path to the Nuget.Config file to supply to the nuget exe")
    DETECT_NUGET_CONFIG_PATH("detect.nuget.config.path", "4.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("Name of the Nuget Inspector")
    DETECT_NUGET_INSPECTOR_NAME("detect.nuget.inspector.name", "3.0.0", PropertyType.STRING, "IntegrationNugetInspector"),
    ...
    DETECT_NUGET_INSPECTOR_VERSION("detect.nuget.inspector.version", "3.0.0", PropertyType.STRING, "latest"),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The names of the projects in a solution to exclude")
    DETECT_NUGET_EXCLUDED_MODULES("detect.nuget.excluded.modules", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The names of the projects in a solution to include (overrides exclude)")
    DETECT_NUGET_INCLUDED_MODULES("detect.nuget.included.modules", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("If true errors will be logged and then ignored.")
    DETECT_NUGET_IGNORE_FAILURE("detect.nuget.ignore.failure", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The name of the dependency scope to include")
    DETECT_MAVEN_SCOPE("detect.maven.scope", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("Maven build command")
    DETECT_MAVEN_BUILD_COMMAND("detect.maven.build.command", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("Path of the Gradle executable")
    DETECT_GRADLE_PATH("detect.gradle.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The path of the Maven executable")
    DETECT_MAVEN_PATH("detect.maven.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The names of the module to exclude")
    DETECT_MAVEN_EXCLUDED_MODULES("detect.maven.excluded.modules", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_MAVEN)
    @HelpDescription("The names of the module to include")
    DETECT_MAVEN_INCLUDED_MODULES("detect.maven.included.modules", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The path of the Nuget executable")
    DETECT_NUGET_PATH("detect.nuget.path", "3.0.0", PropertyType.STRING),
    ...
    DETECT_PIP_PROJECT_NAME("detect.pip.project.name", "3.0.0", PropertyType.STRING),
    ...
    DETECT_PIP_PROJECT_VERSION_NAME("detect.pip.project.version.name", "4.1.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PYTHON)
    @HelpDescription("If true will use Python 3 if available on class path")
    DETECT_PYTHON_PYTHON3("detect.python.python3", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PYTHON)
    @HelpDescription("The path of the Python executable")
    DETECT_PYTHON_PATH("detect.python.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PIP)
    @HelpDescription("The path of the Pipenv executable")
    DETECT_PIPENV_PATH("detect.pipenv.path", "4.1.0", PropertyType.STRING),
    ...
    DETECT_NPM_ARGUMENTS("detect.npm.arguments", "4.3.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NPM)
    @HelpDescription("The path of the Npm executable")
    DETECT_NPM_PATH("detect.npm.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NPM)
    @HelpDescription("Set this value to false if you would like to exclude your dev dependencies when ran")
    DETECT_NPM_INCLUDE_DEV_DEPENDENCIES("detect.npm.include.dev.dependencies", "3.0.0", PropertyType.BOOLEAN, "true"),

    @HelpGroup(primary = GROUP_NPM)
    @HelpDescription("The path of the node executable that is used by Npm")
    DETECT_NPM_NODE_PATH("detect.npm.node.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PEAR)
    @HelpDescription("The path of the pear executable")
    DETECT_PEAR_PATH("detect.pear.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PEAR)
    @HelpDescription("Set to true if you would like to include only required packages")
    DETECT_PEAR_ONLY_REQUIRED_DEPS("detect.pear.only.required.deps", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PIP)
    @HelpDescription("The path of the requirements.txt file")
    DETECT_PIP_REQUIREMENTS_PATH("detect.pip.requirements.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GO)
    @HelpDescription("Path of the Go Dep executable")
    DETECT_GO_DEP_PATH("detect.go.dep.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GO)
    @HelpDescription("If set to true, we will attempt to run 'init' and 'ensure' which can modify your development environment.")
    DETECT_GO_RUN_DEP_INIT("detect.go.run.dep.init", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("Path of the docker executable")
    DETECT_DOCKER_PATH("detect.docker.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("If set to false, detect will attempt to run docker even if it cannot find a docker path.")
    DETECT_DOCKER_PATH_REQUIRED("detect.docker.path.required", "4.0.0", PropertyType.BOOLEAN, "true"),
    ...
    DETECT_DOCKER_INSPECTOR_PATH("detect.docker.inspector.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("Version of the Docker Inspector to use")
    DETECT_DOCKER_INSPECTOR_VERSION("detect.docker.inspector.version", "3.0.0", PropertyType.STRING, "6.*"),
    ...
    DETECT_DOCKER_TAR("detect.docker.tar", "3.0.0", PropertyType.STRING),
    ...
    DETECT_DOCKER_IMAGE("detect.docker.image", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PATHS)
    @HelpDescription("Path of the bash executable")
    DETECT_BASH_PATH("detect.bash.path", "3.0.0", PropertyType.STRING),
    ...
    LOGGING_LEVEL_COM_BLACKDUCKSOFTWARE_INTEGRATION("logging.level.com.blackducksoftware.integration", "3.0.0", PropertyType.STRING, "INFO"),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_DRY_RUN("detect.hub.signature.scanner.dry.run", "3.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_DRY_RUN("detect.blackduck.signature.scanner.dry.run", "4.2.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_SNIPPET_MODE("detect.hub.signature.scanner.snippet.mode", "3.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MODE("detect.blackduck.signature.scanner.snippet.mode", "4.2.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_PATTERNS("detect.hub.signature.scanner.exclusion.patterns", "3.0.0", PropertyType.STRING_ARRAY),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Enables you to specify sub-directories to exclude from scans")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERNS("detect.blackduck.signature.scanner.exclusion.patterns", "4.2.0", PropertyType.STRING_ARRAY),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_PATHS("detect.hub.signature.scanner.paths", "3.0.0", PropertyType.STRING_ARRAY),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("These paths and only these paths will be scanned.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_PATHS("detect.blackduck.signature.scanner.paths", "4.2.0", PropertyType.STRING_ARRAY),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS("detect.hub.signature.scanner.exclusion.name.patterns", "4.0.0", PropertyType.STRING_ARRAY, "node_modules"),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Comma separated list of file name patterns to exclude from the signature scan.")
    @HelpDetailed("Detect will recursively search within the scan targets for files/directories that match these file name patterns and will create the corresponding exclusion patterns for the signature scanner.\r\nThese patterns will be added to the patterns provided by detect.hub.signature.scanner.exclusion.patterns")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS("detect.blackduck.signature.scanner.exclusion.name.patterns", "4.2.0", PropertyType.STRING_ARRAY, "node_modules"),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_MEMORY("detect.hub.signature.scanner.memory", "3.0.0", PropertyType.INTEGER, "4096"),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("The memory for the scanner to use.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_MEMORY("detect.blackduck.signature.scanner.memory", "4.2.0", PropertyType.INTEGER, "4096"),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_DISABLED("detect.hub.signature.scanner.disabled", "3.0.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_DISABLED("detect.blackduck.signature.scanner.disabled", "4.2.0", PropertyType.BOOLEAN, "false"),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH("detect.hub.signature.scanner.offline.local.path", "3.0.0", PropertyType.STRING),
    ...
    @HelpDescription("To use a local signature scanner and force offline, specify the path where the signature scanner was unzipped. This will likely look similar to 'scan.cli-x.y.z' and includes the 'bin, icon, jre, and lib' directories of the expanded scan.cli.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH("detect.blackduck.signature.scanner.offline.local.path", "4.2.0", PropertyType.STRING),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_LOCAL_PATH("detect.hub.signature.scanner.local.path", "4.2.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_OFFLINE, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("To use a local signature scanner, specify the path where the signature scanner was unzipped. This will likely look similar to 'scan.cli-x.y.z' and includes the 'bin, icon, jre, and lib' directories of the expanded scan.cli.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_LOCAL_PATH("detect.blackduck.signature.scanner.local.path", "4.2.0", PropertyType.STRING),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_HOST_URL("detect.hub.signature.scanner.host.url", "3.0.0", PropertyType.STRING),
    ...
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_HOST_URL("detect.blackduck.signature.scanner.host.url", "4.2.0", PropertyType.STRING),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_PARALLEL_PROCESSORS("detect.hub.signature.scanner.parallel.processors", "3.0.0", PropertyType.INTEGER, "1"),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("The number of scans to run in parallel, defaults to 1, but if you specify -1, the number of processors on the machine will be used.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_PARALLEL_PROCESSORS("detect.blackduck.signature.scanner.parallel.processors", "4.2.0", PropertyType.INTEGER, "1"),
    ...
    DETECT_HUB_SIGNATURE_SCANNER_ARGUMENTS("detect.hub.signature.scanner.arguments", "4.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("Additional arguments to use when running the Black Duck signature scanner.")
    DETECT_BLACKDUCK_SIGNATURE_SCANNER_ARGUMENTS("detect.blackduck.signature.scanner.arguments", "4.2.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SIGNATURE_SCANNER, additional = { SEARCH_GROUP_SIGNATURE_SCANNER, SEARCH_GROUP_BLACKDUCK })
    @HelpDescription("The path of a binary file to scan.")
    DETECT_BINARY_SCAN_FILE("detect.binary.scan.file.path", "4.2.0", PropertyType.STRING),
    ...
    DETECT_PACKAGIST_INCLUDE_DEV_DEPENDENCIES("detect.packagist.include.dev.dependencies", "3.0.0", PropertyType.BOOLEAN, "true"),

    @HelpGroup(primary = GROUP_CPAN)
    @HelpDescription("The path of the perl executable")
    DETECT_PERL_PATH("detect.perl.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_CPAN)
    @HelpDescription("The path of the cpan executable")
    DETECT_CPAN_PATH("detect.cpan.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_CPAN)
    @HelpDescription("The path of the cpanm executable")
    DETECT_CPANM_PATH("detect.cpanm.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SBT)
    @HelpDescription("The names of the sbt configurations to exclude")
    DETECT_SBT_EXCLUDED_CONFIGURATIONS("detect.sbt.excluded.configurations", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_SBT)
    @HelpDescription("The names of the sbt configurations to include")
    DETECT_SBT_INCLUDED_CONFIGURATIONS("detect.sbt.included.configurations", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The scheme to use when the package managers can not determine a version, either 'text' or 'timestamp'")
    DETECT_DEFAULT_PROJECT_VERSION_SCHEME("detect.default.project.version.scheme", "3.0.0", PropertyType.STRING, "text"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The text to use as the default project version")
    DETECT_DEFAULT_PROJECT_VERSION_TEXT("detect.default.project.version.text", "3.0.0", PropertyType.STRING, "Default Detect Version"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The timestamp format to use as the default project version")
    DETECT_DEFAULT_PROJECT_VERSION_TIMEFORMAT("detect.default.project.version.timeformat", "3.0.0", PropertyType.STRING, "yyyy-MM-dd\\'T\\'HH:mm:ss.SSS"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("If set, this will aggregate all the BOMs to create a single BDIO file with the name provided.")
    DETECT_BOM_AGGREGATE_NAME("detect.bom.aggregate.name", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("When set to true, a Black Duck risk report in PDF form will be created")
    DETECT_RISK_REPORT_PDF("detect.risk.report.pdf", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The output directory for risk report in PDF. Default is the source directory")
    DETECT_RISK_REPORT_PDF_PATH("detect.risk.report.pdf.path", "3.0.0", PropertyType.STRING, "."),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("When set to true, a Black Duck notices report in text form will be created in your source directory")
    DETECT_NOTICES_REPORT("detect.notices.report", "3.0.0", PropertyType.BOOLEAN, "false"),

    @HelpGroup(primary = GROUP_PROJECT_INFO, additional = { SEARCH_GROUP_PROJECT })
    @HelpDescription("The output directory for notices report. Default is the source directory")
    DETECT_NOTICES_REPORT_PATH("detect.notices.report.path", "3.0.0", PropertyType.STRING, "."),

    @HelpGroup(primary = GROUP_BITBAKE)
    @HelpDescription("The name of the build environment init script")
    DETECT_INIT_BUILD_ENV_NAME("detect.bitbake.build.env.name", "4.4.0", PropertyType.STRING, "oe-init-build-env"),

    @HelpGroup(primary = GROUP_BITBAKE)
    @HelpDescription("The name of the package to extract dependencies from")
    DETECT_BITBAKE_PACKAGE_NAME("detect.bitbake.package.name", "4.4.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_CONDA)
    @HelpDescription("The path of the conda executable")
    DETECT_CONDA_PATH("detect.conda.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_CONDA)
    @HelpDescription("The name of the anaconda environment used by your project")
    DETECT_CONDA_ENVIRONMENT_NAME("detect.conda.environment.name", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_DOCKER)
    @HelpDescription("The path to the directory containing the docker inspector script, jar, and images")
    DETECT_DOCKER_INSPECTOR_AIR_GAP_PATH("detect.docker.inspector.air.gap.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The path to the directory containing the air gap dependencies for the gradle inspector")
    DETECT_GRADLE_INSPECTOR_AIR_GAP_PATH("detect.gradle.inspector.air.gap.path", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_NUGET)
    @HelpDescription("The path to the directory containing the nuget inspector nupkg")
    DETECT_NUGET_INSPECTOR_AIR_GAP_PATH("detect.nuget.inspector.air.gap.path", "3.0.0", PropertyType.STRING),
    ...
    DETECT_NUGET_PACKAGES_REPO_URL("detect.nuget.packages.repo.url", "3.0.0", PropertyType.STRING_ARRAY, "https://api.nuget.org/v3/index.json"),

    @HelpGroup(primary = GROUP_GRADLE)
    @HelpDescription("The respository gradle should use to look for the gradle inspector")
    DETECT_GRADLE_INSPECTOR_REPOSITORY_URL("detect.gradle.inspector.repository.url", "3.0.0", PropertyType.STRING),

    @HelpGroup(primary = GROUP_HEX)
    @HelpDescription("The path of the rebar3 executable")
    DETECT_HEX_REBAR3_PATH("detect.hex.rebar3.path", "3.0.0", PropertyType.STRING),

    @HelpDescription("The path of the Yarn executable")
    @HelpGroup(primary = GROUP_YARN)
    DETECT_YARN_PATH("detect.yarn.path", "4.0.0", PropertyType.STRING),

    @HelpDescription("Set this to true to only scan production dependencies")
    @HelpGroup(primary = GROUP_YARN)
    DETECT_YARN_PROD_ONLY("detect.yarn.prod.only", "4.0.0", PropertyType.BOOLEAN, "false");
    ...
    DetectProperty(final String propertyName, final String asOf, final PropertyType propertyType) {
    ...
    DetectProperty(final String propertyName, final String asOf, final PropertyType propertyType, final String defaultValue) {
        this.propertyName = propertyName;
        this.asOf = asOf;
        this.propertyType = propertyType;
