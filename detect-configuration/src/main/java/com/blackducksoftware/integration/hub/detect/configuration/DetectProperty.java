...
public enum DetectProperty {
    ...
    DETECT_DETECTOR_SEARCH_EXCLUSION_PATTERNS("detect.detector.search.exclusion.patterns", "3.2.0", PropertyType.STRING_ARRAY, PropertyAuthority.None),
    ...
    DETECT_REPORT_TIMEOUT("detect.report.timeout", "3.0.0", PropertyType.LONG, PropertyAuthority.None, "300"),
