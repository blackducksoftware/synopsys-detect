...
public class DetectListOption extends DetectOption {
    public DetectListOption(final DetectProperty detectProperty, final boolean strictValidation, final boolean caseSensitiveValidation, final List<String> validValues, final DetectOptionMetaData detectOptionMetaData,
