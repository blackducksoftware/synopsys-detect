...
enum class BazelDependencyType {
    maven_jar,
    maven_install,
    UNSPECIFIED
}
...
class DetectProperties {
    companion object {
        ...
        val DETECT_BAZEL_CQUERY_OPTIONS = OptionalStringProperty("detect.bazel.cquery.options")
        val DETECT_BAZEL_DEPENDENCY_RULE = RequiredEnumProperty("detect.bazel.dependency.type", BazelDependencyType.UNSPECIFIED, BazelDependencyType::valueOf, BazelDependencyType.values().toList())
        ...
        val DETECT_MAVEN_INCLUDE_PLUGINS = OptionalBooleanProperty("detect.maven.include.plugins")
        ...
        val DETECT_PIP_REQUIREMENTS_PATH = OptionalStringArrayProperty("detect.pip.requirements.path")
