...
public enum DetectProperty {
    ...
    DETECT_BOM_AGGREGATE_REMEDIATION_MODE("detect.bom.aggregate.remediation.mode", "BDIO Aggregate Direct", "6.1.0", PropertyType.STRING, PropertyAuthority.NONE, "TRANSITIVE"),
