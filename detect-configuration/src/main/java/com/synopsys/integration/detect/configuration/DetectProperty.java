...
public enum DetectProperty {
    ...
    @HelpDescription(category = ADVANCED, value = "By default, all detectors will be included. If you want to exclude specific detectors, specify the ones to exclude here. If you want to exclude all detectors, specify \"ALL\". Exclusion rules always win. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_GRADLE, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription(category = ADVANCED, value = "A comma-separated list of Gradle configurations to exclude. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_GRADLE, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription(category = ADVANCED, value = "A comma-separated list of Gradle sub-projects to exclude. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_GRADLE, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription(category = ADVANCED, value = "A comma-separated list of Gradle configurations to include. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_GRADLE, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription(category = ADVANCED, value = "A comma-separated list of Gradle sub-projects to include. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_DETECTOR, additional = { SEARCH_GROUP_GLOBAL })
    @HelpDescription(category = ADVANCED, value = "By default, all tools will be included. If you want to include only specific tools, specify the ones to include here. Exclusion rules always win. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_MAVEN, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription(category = ADVANCED, value = "A comma-separated list of Maven modules (sub-projects) to exclude. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_MAVEN, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription(category = ADVANCED, value = "A comma-separated list of Maven modules (sub-projects) to include. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_MAVEN, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription("A comma separated list of Maven scopes. Output will be limited to dependencies within these scopes (overridden by exclude). <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_MAVEN, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription("A comma separated list of Maven scopes. Output will be limited to dependencies outside these scopes (overrides include). <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpDescription(category = ADVANCED, value = "The names of the sbt configurations to exclude. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_SBT, additional = { GROUP_SOURCE_SCAN })
    @HelpDescription(category = ADVANCED, value = "The names of the sbt configurations to include. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_PATHS, additional = { SEARCH_GROUP_GLOBAL })
    @HelpDescription("The tools Detect should allow in a comma-separated list. Tools in this list (as long as they are not also in the excluded list) will be allowed to run if all criteria of the tool are met. Exclusion rules always win. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
    ...
    @HelpGroup(primary = GROUP_PATHS, additional = { SEARCH_GROUP_GLOBAL })
    @HelpDescription("The tools Detect should not allow, in a comma-separated list. Excluded tools will not be run even if all criteria for the tool is met. Exclusion rules always win. <a href=\"/advanced/includeexcludewildcards\">Wildcards</a> are supported.")
