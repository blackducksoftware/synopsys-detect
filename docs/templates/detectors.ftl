...
by increasing the detector search depth. For more information, refer to [detector search depth](/properties/configuration/paths/#detector-search-depth-advanced).
...
Build detectors run package manager commands; for example: *mvn dependency:tree*, and/or inspectors; for example, the [Gradle inspector](/components/inspectors/#gradle-inspector) to derive dependency information. Inspectors
