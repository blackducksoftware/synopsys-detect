...
## Quick Links
* [All Properties](properties/all-properties.md)
* [Exit Codes](advanced/troubleshooting/exit-codes.md)
...
| Air Gap Creation | --zip | -z | Creates an air gap zip for running ${solution_name} offline. |
