...
* The Project Manager role on the project is required to generate reports.
...
* A user with the Global Code Scanner role can generate a report, but cannot delete the report. The Project Manager role on the project is required to delete the report.
