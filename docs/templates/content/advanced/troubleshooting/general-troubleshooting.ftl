...
[--detect.diagnostic](../../../properties/configuration/debug/#diagnostic-mode): When enabled, diagnostic mode collects all files generated by ${solution_name} and zips the files using a unique run ID. It includes logs, BDIO files, extraction files, and reports.

[--detect.diagnostic.extended](../../../properties/configuration/debug/#diagnostic-mode-extended): When enabled, ${solution_name} collects relevant files such as lock files and build artifacts.
