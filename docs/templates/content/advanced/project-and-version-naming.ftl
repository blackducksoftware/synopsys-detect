...
Project information is extracted from the remote URL for the current branch. The version is the current branch name.  This is done by the Git detector. If you don't want ${solution_name} to use Git data, omit the Git detector using the following property:
```
