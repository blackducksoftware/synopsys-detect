...
${solution_name} does not currently support Yarn workspaces as defined [https://classic.yarnpkg.com/en/docs/workspaces/](https://classic.yarnpkg.com/en/docs/workspaces/).