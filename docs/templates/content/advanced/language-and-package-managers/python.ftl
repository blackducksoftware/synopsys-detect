...
The Pip detector attempts to run on your project if either a setup.py file is found, or a requirements.txt file is provided using the (requirements path property)[../../../properties/detectors/pip/#pip-requirements-path-advanced] property.
