...
* ${solution_name} looks for Python or Python 3 on $PATH if the Python 3 property is set to true. You can override this by setting the Python path property.
* ${solution_name} looks for pip or pip3 on $PATH if the Python 3 property is set to true.
