...
-de --diagnosticExtended [--detect.diagnostic.extended](../../../properties/configuration/debug/#diagnostic-mode-extended): When enabled, ${solution_name} generates a zip file for troubleshooting (a "diagnostic zip") that includes all files most likely to be needed for troubleshotting, including log files, BDIO files, extraction files, reports, and ${solution_name} input files such as lock files.

-d --diagnostic [--detect.diagnostic](../../../properties/configuration/debug/#diagnostic-mode): When enabled, ${solution_name} generates a diagnostic zip that only includes files generated by ${solution_name}.
