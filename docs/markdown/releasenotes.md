...
* Added support for running IaC scans via [solution_name]. See [IaC properties](properties/configuration/iac-scan.md) for more details. Note: IaC capabilities require Black Duck 2022.7.0 or later.
