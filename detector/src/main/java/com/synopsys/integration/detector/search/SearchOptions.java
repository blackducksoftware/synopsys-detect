...
public class SearchOptions {
    ...
    public final DetectorFilter detectorFilter;

    public SearchOptions(File searchPath, List<String> excludedDirectories, List<String> excludedDirectoryPatterns, boolean forceNestedSearch, int maxDepth, DetectorFilter detectorFilter) {
