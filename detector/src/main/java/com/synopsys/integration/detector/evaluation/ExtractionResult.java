...
public class ExtractionResult {
    ...
    private final List<CodeLocation> detectCodeLocations;

    public ExtractionResult(final List<CodeLocation> detectCodeLocations, final Set<DetectorType> successfulBomToolGroups, final Set<DetectorType> failedBomToolGroups) {
