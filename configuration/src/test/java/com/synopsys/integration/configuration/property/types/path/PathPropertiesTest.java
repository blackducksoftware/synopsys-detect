...
public class PathPropertiesTest {
    ...
    public void testNullable() throws InvalidPropertyException {
        NullableProperty<PathValue> property = new NullablePathProperty("path.nullable");
    ...
    public void testValued() throws InvalidPropertyException {
        ValuedProperty<PathValue> property = new PathProperty("path.valued", new PathValue("/tmp/test"));
    ...
    public void testList() throws InvalidPropertyException {
        ValuedListProperty<PathValue> property = new PathListProperty("path.list", emptyList());
