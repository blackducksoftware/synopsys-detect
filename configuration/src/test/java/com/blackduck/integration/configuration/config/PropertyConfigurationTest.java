...
public class PropertyConfigurationTest {
    ...
    public void getValueNullableNull() throws InvalidPropertyException {
        NullableAlikeProperty<String> NullableAlikeProperty = new NullableTestProperty("example.key");
        Assertions.assertEquals(Optional.empty(), ConfigTestUtils.emptyConfig().getValue(NullableAlikeProperty), "Config should provide an empty Optional if the property is nullable.");
    }
    ...
    public void getValueProvidesDefault() throws InvalidPropertyException {
        ...
        Assertions.assertEquals(
            ...
            ConfigTestUtils.emptyConfig().getValue(propertyWithDefault),
    ...
    public void wasKeyProvided() {
        ...
        Assertions.assertTrue(ConfigTestUtils.configOf(Pair.of(exampleKey, UNKNOWN_VALUE)).wasKeyProvided(exampleKey), "The key was provided.");
        Assertions.assertFalse(ConfigTestUtils.emptyConfig().wasKeyProvided(exampleKey), "The key was not provided.");
    }
    ...
    public void wasPropertyProvided() {
        ...
        Assertions.assertFalse(ConfigTestUtils.emptyConfig().wasPropertyProvided(propertyWithDefault), "The property was not provided.");
    }
    ...
    public void getPropertySource() {
        ...
        Assertions.assertEquals(Optional.empty(), ConfigTestUtils.emptyConfig().getPropertySource(NullableAlikeProperty), "The property is not provided and therefore should not have a source.");
    }
    ...
    public void getPropertyOrigin() {
        ...
        Assertions.assertEquals(Optional.empty(), ConfigTestUtils.emptyConfig().getPropertyOrigin(NullableAlikeProperty), "The property was not provided and should not have an origin.");
    }
    ...
    public void getKeys() {
        Assertions.assertEquals(
            ...
            ConfigTestUtils.configOf(Pair.of("example.key", UNKNOWN_VALUE), Pair.of("other.key", UNKNOWN_VALUE)).getKeys(),
            "The set of keys returned is not identical to all those provided."
        );
        Assertions.assertEquals(Collections.emptySet(), ConfigTestUtils.emptyConfig().getKeys(), "The property was not provided and should not have an origin.");
    }
    ...
    public void getPropertyException() {
        ...
        Assertions.assertEquals(
            Optional.empty(),
            ConfigTestUtils.emptyConfig().getPropertyException(NullableAlikeProperty),
    ...
    public void getRawFromProperty() {
        ...
        Assertions.assertEquals(Optional.empty(), ConfigTestUtils.emptyConfig().getRaw(NullableAlikeProperty), "The property was not provided and should not resolve a value.");
    }
    ...
    public void getRaw() {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(propertyMap);
        ...
        Assertions.assertEquals(emptyMap(), ConfigTestUtils.emptyConfig().getRaw(), "The config should not have any values to provide.");
    }
    ...
    public void getRawValueMap() {
        ...
        PropertyConfiguration configuration = ConfigTestUtils.configOf(propertyMap);
    ...
    public void getRawPassthroughMultipleValues() {
        ...
        PropertySource secondarySource = ConfigTestUtils.propertySourceOf("secondary", Pair.of("pass.two", "two value"), Pair.of("ignore", "ignore value"));
        PropertySource primarySource = ConfigTestUtils.propertySourceOf("primary", Pair.of("pass.one", "one value"));
        PropertyConfiguration configuration = ConfigTestUtils.configOf(primarySource, secondarySource);
    ...
    public void getRawPassthroughPrimary() {
        PassthroughProperty passthrough = new PassthroughProperty("pass");
        PropertySource secondarySource = ConfigTestUtils.propertySourceOf("secondary", Pair.of("pass.shared", "secondaryValue"));
        PropertySource primarySource = ConfigTestUtils.propertySourceOf("primary", Pair.of("pass.shared", "primaryValue"));
        PropertyConfiguration configuration = ConfigTestUtils.configOf(primarySource, secondarySource);
