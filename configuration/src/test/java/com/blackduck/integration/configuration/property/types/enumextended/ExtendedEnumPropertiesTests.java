...
public class ExtendedEnumPropertiesTests {
    ...
    public void testNullable() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("enum.nullable", "NONE"));
    ...
    public void testList() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("enum.nullable", "THIRD,NONE"));
