...
class BooleanPropertiesTests {
    ...
    public void testNullable() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("boolean.nullable", "true"));
    ...
    public void testValued() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("boolean.valued", "true"));
    ...
    public void testList() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("boolean.list", "true, true"));
