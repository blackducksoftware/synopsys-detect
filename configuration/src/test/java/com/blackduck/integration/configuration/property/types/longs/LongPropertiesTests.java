...
public class LongPropertiesTests {
    ...
    public void testNullable() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("long.nullable", "2"));
    ...
    public void testValued() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("long.valued", "5"));
    ...
    public void testList() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("long.list", "2,3"));
