...
public class PathPropertiesTest {
    ...
    public void testNullable() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("path.nullable", "/new/path"));
    ...
    public void testValued() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("path.valued", "/new/path"));
    ...
    public void testList() throws InvalidPropertyException {
        ...
        PropertyConfiguration config = ConfigTestUtils.configOf(Pair.of("path.list", "/new/path,/other/new/path"));
