...
public class NoneEnumListProperty<B extends Enum<B>> extends ExtendedEnumListPropertyBase<NoneEnum, B, NoneEnumList<B>> {
    ...
    public static <B extends Enum<B>> PropertyBuilder<NoneEnumListProperty<B>> newBuilder(@NotNull String key, List<ExtendedEnumValue<NoneEnum, B>> defaultValue, @NotNull Class<B> eClass) {
    ...
    public static <B extends Enum<B>> PropertyBuilder<NoneEnumListProperty<B>> newBuilder(@NotNull String key, @NotNull NoneEnum noneValue, @NotNull Class<B> eClass) {
        return new PropertyBuilder<NoneEnumListProperty<B>>().setCreator(() -> new NoneEnumListProperty<>(key, Collections.singletonList(ExtendedEnumValue.ofExtendedValue(noneValue)), eClass));
    }
    ...
    public static <B extends Enum<B>> PropertyBuilder<NoneEnumListProperty<B>> newBuilder(@NotNull String key, @NotNull B extendedValue, @NotNull Class<B> eClass) {
        return new PropertyBuilder<NoneEnumListProperty<B>>().setCreator(() -> new NoneEnumListProperty<>(key, Collections.singletonList(ExtendedEnumValue.ofBaseValue(extendedValue)), eClass));
    }
