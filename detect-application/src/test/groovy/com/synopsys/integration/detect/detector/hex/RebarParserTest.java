...
import static com.synopsys.integration.detect.testutils.DependencyGraphResourceTestUtil.assertGraph;
...
public class RebarParserTest {
    ...
    public void testParseRebarTreeOutput() {
        ...
        DependencyGraphResourceTestUtil.assertGraph(expectedGraph, actualGraph);
    }
    ...
    private DetectCodeLocation build(final String resource) {
        ...
        final RebarParseResult result = rebarTreeParser.parseRebarTreeOutput(dependencyTreeOutput, "");
