...
| DETECT_JAVA_PATH | The path to the Java executable used to execute Docker Inspector | The path to the Java executable file. | To set the Java instance used by [solution_name], see JAVA_HOME. |
