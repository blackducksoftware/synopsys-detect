...
* The output for the security errors and warnings sections of Rapid and Ephemeral Scan Modes now includes the name of the vulnerable component, followed by a list of vulnerabilities, followed by upgrade guidance. 
