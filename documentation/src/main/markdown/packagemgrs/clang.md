...
For C/C++ projects on Linux systems that meet these requirements, [detect_product_short] can derive
...
[detect_product_short] will only find components that have been installed into the Linux package manager database.

The JSON compilation database
must be generated by your project build before running [detect_product_short].
...
to enable [detect_product_short] to find it.
