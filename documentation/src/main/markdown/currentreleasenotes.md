...
* (IDETECT-3888) Improved runtime performance PIP Inspector in the case of aws-cdk dependencies by passing package history list by reference instead of value.
* (IDETECT-3867) Resolved lack of support for properties set in SPRING_APPLICATION_JSON environment variable to configure Detect when Self Update feature issue is utilized.
