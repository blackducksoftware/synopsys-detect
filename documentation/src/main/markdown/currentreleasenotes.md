...
* Removed dependency on [solution_name] dependencies for init-detect.gradle script. This will prevent [solution_name]'s dependencies from being included in the dependency verification by Gradle.
