...
* Switched from Universal Analytics to Google Analytics 4 (GA4) as our phone home analytics measurement solution using the https://www.google-analytics.com/mp/collect endpoint. 
