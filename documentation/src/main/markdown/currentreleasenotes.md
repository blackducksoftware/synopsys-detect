...
* (IDETECT-4469) - Eliminating null (`\u0000`) and replacement (`\uFFFD`) characters during the processing of requirements.txt files to ensure successful extraction of dependency information.
