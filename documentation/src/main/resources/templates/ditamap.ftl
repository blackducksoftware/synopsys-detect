...
<map id="detect-user-guide" xml:lang="en-US">
  <title>${detect_product_short} ${program_version}</title>
  <topicmeta>
    <shortdesc>${detect_product_short} is a client that scans code bases in your projects and folders to perform compositional analysis.</shortdesc>
    <!-- zoomin bundle name -->
