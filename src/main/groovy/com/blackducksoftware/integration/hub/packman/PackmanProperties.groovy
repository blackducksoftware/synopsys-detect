...
class PackmanProperties {
    ...
    @ValueDescription(description="The name of the Pip inspector")
    @Value('${packman.pip.inpsector.name}')
    String pipInspectorName

    @ValueDescription(description="The version of the Pip inspector")
