...
class DependenciesParser {
    private final Logger logger = LoggerFactory.getLogger(DependenciesParser.class)
    ...
    void populateDependencyNodeFromDependencies(DependencyNode rootProject, String dependencies, ExcludedIncludedFilter configurationFilter) {
