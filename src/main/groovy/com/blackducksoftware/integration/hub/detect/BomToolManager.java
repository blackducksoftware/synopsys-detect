...
public class BomToolManager {
    ...
    // final ExcludedIncludedFilter toolFilter = new
    // ExcludedIncludedFilter(detectConfiguration.getExcludedBomToolTypes(),
    ...
    // }
    //
    // private void createOutput(final List<File> createdBdioFiles, final BomToolType bomToolType, final
    ...
    // final String safeTargetName = escapeUtil.escapeForUri(project.getTargetName());
    // final String safeName = String.format("%s_%s_%s_%s_bdio", bomToolType.toString(), safeTargetName,
    // safeProjectName, safeVersionName);
    ...
    // final String codeLocation = projectInfoGatherer.getCodeLocationName(bomToolType, project.getTargetName(),
    // dependencyNode.name,
    // dependencyNode.version);
    // final SimpleBdioDocument bdioDocument = dependencyNodeTransformer.transformDependencyNode(codeLocation,
    // dependencyNode);
    //
