...
public class ScanCodeLocationName {
    ...
    public ScanCodeLocationName(final String projectName, final String projectVersionName, final BomToolType bomToolType, final String sourcePath, final String scanTargetPath, final String prefix, final String suffix,
