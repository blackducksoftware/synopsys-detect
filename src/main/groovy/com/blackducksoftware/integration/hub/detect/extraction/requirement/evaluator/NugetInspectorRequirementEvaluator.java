...
@Component
public class NugetInspectorRequirementEvaluator extends RequirementEvaluator<NugetInspectorRequirement> {
    private final Logger logger = LoggerFactory.getLogger(NugetInspectorRequirementEvaluator.class);
    ...
    public Class getRequirementClass() {
        return NugetInspectorRequirement.class;
    }
