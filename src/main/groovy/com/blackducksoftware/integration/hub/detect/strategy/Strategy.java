...
public abstract class Strategy {
    ...
    public StrategyResult searchable(final StrategyEnvironment environment, final ExtractionContext context) {
    ...
    public abstract StrategyResult applicable(final StrategyEnvironment environment, final ExtractionContext context);
    ...
    public abstract StrategyResult extractable(final StrategyEnvironment environment, final ExtractionContext context) throws StrategyException;

    public abstract Extraction extract(final StrategyEnvironment environment, final ExtractionContext context);
