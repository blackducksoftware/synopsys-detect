...
class DetectConfiguration {
    ...
    @ValueDescription(description="By default, no tier is set for the project created. If supplied, your project will be created with this tier", group=DetectConfiguration.GROUP_PROJECT_INFO)
