...
public class GradleExtractor extends Extractor<GradleContext> {
    ...
    @Override
    public Extraction extract(final GradleContext context) {
        final String gradleCommand = detectConfiguration.getGradleBuildCommand();
        ...
        final File[] codeLocationFiles = detectFileManager.findFiles(blackduckDirectory, "*_dependencyGraph.txt");
