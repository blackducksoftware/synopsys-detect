...
class DetectProjectManager {
    ...
    private SimpleBdioDocument createSimpleBdioDocument(DetectProject detectProject, DetectCodeLocation detectCodeLocation) {
        final String codeLocationName = detectProject.getCodeLocationName(detectFileManager, detectCodeLocation.bomToolType, detectCodeLocation.sourcePath, detectConfiguration.getProjectCodeLocationPrefix(), 'Hub Detect Tool')
