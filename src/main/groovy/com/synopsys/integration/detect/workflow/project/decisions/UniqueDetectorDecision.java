...
public class UniqueDetectorDecision extends NameVersionDecision {
    ...
    public UniqueDetectorDecision(final DetectorProjectInfo chosenDetectorProjectInfo) {
    ...
    public void printDescription(final Logger logger) {
        logger.info("Exactly one unique detector was found. Using " + chosenDetectorProjectInfo.getDetectorType().toString() + " found at depth " + Integer.toString(chosenDetectorProjectInfo.getDepth()) + " as project info.");
    }
