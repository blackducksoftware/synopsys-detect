...
public class EnumUtilExtension {
    ...
    public static <T extends Enum<T>> List<T> parseCommaDelimitted(String commaDelimitedEnumString, Class<T> enumClass) {
        return Arrays.stream(commaDelimitedEnumString.split(","))
                   .map(String::trim)
