...
public class BlackDuckSignatureScannerTool {
    ...
    public SignatureScannerToolResult runScanTool(BlackDuckRunData blackDuckRunData, NameVersion projectNameVersion, Optional<File> dockerTar, final Optional<String> detectableProvidedJavaOptions) throws DetectUserFriendlyException {
        ...
        try {
            if (blackDuckServerConfig.isPresent()) {
                ...
                CodeLocationCreationData<ScanBatchOutput> codeLocationCreationData = blackDuckSignatureScanner.performOnlineScan(projectNameVersion, installDirectory, dockerTar.orElse(null), detectableProvidedJavaOptions.orElse(null));
                ...
                ScanBatchOutput scanBatchOutput = blackDuckSignatureScanner.performScanActions(projectNameVersion, installDirectory, dockerTar.orElse(null), detectableProvidedJavaOptions.orElse(null));
