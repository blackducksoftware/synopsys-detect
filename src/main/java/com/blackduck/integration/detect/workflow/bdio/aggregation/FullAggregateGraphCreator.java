package com.blackduck.integration.detect.workflow.bdio.aggregation;
...
public class FullAggregateGraphCreator {
    ...
    public ProjectDependencyGraph aggregateCodeLocations(File sourcePath, NameVersion projectNameVersion, List<DetectCodeLocation> codeLocations) {
        ExternalId projectExternalId = ExternalId.FACTORY.createNameVersionExternalId(CodeLocationConverter.DETECT_FORGE, projectNameVersion.getName(), projectNameVersion.getVersion());
