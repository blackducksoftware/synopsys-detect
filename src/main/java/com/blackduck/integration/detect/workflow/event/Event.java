...
public class Event {
    ...
    public static final EventType<com.blackduck.integration.detect.workflow.status.UnrecognizedPaths> UnrecognizedPaths = new EventType<>(UnrecognizedPaths.class);
