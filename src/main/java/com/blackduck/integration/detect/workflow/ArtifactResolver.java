...
public class ArtifactResolver {
     ...
     * @param repositoryUrl           The url of the repository with the artifact, such as bds-integrations-release/com/blackduck/integration/integration-gradle-inspector
