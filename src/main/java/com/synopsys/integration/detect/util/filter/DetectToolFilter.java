...
public class DetectToolFilter {
    ...
    private final List<DetectTool> allowedStatelessTools = Arrays.asList(DetectTool.BAZEL, DetectTool.DETECTOR, DetectTool.SIGNATURE_SCAN, DetectTool.DOCKER, DetectTool.BINARY_SCAN);    
