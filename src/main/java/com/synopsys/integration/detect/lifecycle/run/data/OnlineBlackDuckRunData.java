...
public class OnlineBlackDuckRunData extends BlackDuckRunData {
    ...
    public OnlineBlackDuckRunData(PhoneHomeManager phoneHomeManager, BlackDuckServerConfig blackDuckServerConfig, BlackDuckServicesFactory blackDuckServicesFactory) {
        super(true);
