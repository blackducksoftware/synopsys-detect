            ...
            if (blackDuckPostOptions.shouldWaitForResults()) {
                ...
                if (codeLocationWaitController.getExpectedNotificationCount() > 0) {
                    ...
                    final CodeLocationWaitResult result = codeLocationCreationService
                        .waitForCodeLocations(notificationTaskRange, codeLocationWaitController.getProjectNameVersion(), codeLocationWaitController.getCodeLocationNames(), codeLocationWaitController.getExpectedNotificationCount(),
                            timeoutInSeconds);
