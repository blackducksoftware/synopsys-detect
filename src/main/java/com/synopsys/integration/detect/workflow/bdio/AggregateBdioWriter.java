...
public class AggregateBdioWriter {
    ...
    public void writeAggregateBdioFile(File aggregateFile, String codeLocationName, NameVersion projectNameVersion, ExternalId projectExternalId, DependencyGraph aggregateDependencyGraph, boolean useBdio2)
    ...
    private void writeAggregateBdio1File(File aggregateFile, String codeLocationName, NameVersion projectNameVersion, ExternalId projectExternalId, DependencyGraph aggregateDependencyGraph)
        throws DetectUserFriendlyException {
        SimpleBdioDocument aggregateBdioDocument = simpleBdioFactory.createSimpleBdioDocument(codeLocationName, projectNameVersion.getName(), projectNameVersion.getVersion(), projectExternalId, aggregateDependencyGraph);

        detectBdioWriter.writeBdioFile(aggregateFile, aggregateBdioDocument);
    }

    private void writeAggregateBdio2File(File aggregateFile, String codeLocationName, NameVersion projectNameVersion, ExternalId projectExternalId, DependencyGraph aggregateDependencyGraph)
        throws DetectUserFriendlyException {
