...
public enum ExitCodeType {
    ...
    FAILURE_BLACKDUCK_VERSION_NOT_SUPPORTED(
        10,
        "Detect's configuration requested an operation that is not supported by your version of Black Duck. Ensure that your Black Duck version is compatible with this version of Detect."
    ),
