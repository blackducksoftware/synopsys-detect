...
public class DetectProperties {
    ...
    // TODO once merged with Jake's changes, change this to thenew  filterable enum type that excludes ALL
    public static final DetectProperty<FilterableEnumListProperty<BitbakeDependencyType>> DETECT_BITBAKE_DEPENDENCY_TYPES_EXCLUDED =
        new DetectProperty<>(new FilterableEnumListProperty<>("detect.bitbake.excluded.dependency.types", Collections.singletonList(FilterableEnumValue.noneValue()), BitbakeDependencyType.class))
