...
public class DetectProperties {
    ...
    public static final DetectProperty<BooleanProperty> DETECT_BITBAKE_INCLUDE_DEV_DEPENDENCIES =
        new DetectProperty<>(new BooleanProperty("detect.bitbake.include.dev.dependencies", true))
            .setInfo("Include Bitbake Development Dependencies", DetectPropertyFromVersion.VERSION_6_4_0)
            .setHelp("Set this value to false if you would like to exclude your dev dependencies.")
            .setGroups(DetectGroup.BITBAKE, DetectGroup.SOURCE_SCAN);
