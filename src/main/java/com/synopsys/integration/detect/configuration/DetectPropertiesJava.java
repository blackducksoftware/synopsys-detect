...
public class DetectPropertiesJava {
    ...
    NullableStringProperty BLACKDUCK_API_TOKEN = new PropertyBuilder<>(new NullableStringProperty("blackduck.api.token")).build(property -> {
    ...
    BooleanProperty BLACKDUCK_OFFLINE_MODE = new PropertyBuilder<>(new BooleanProperty("blackduck.offline.mode", false)).build(property -> {
    ...
    Property BLACKDUCK_PASSWORD = new PropertyBuilder<>(new NullableStringProperty("blackduck.password")).build(property -> {
        property.setInfo("Black Duck Password", "4.2.0");
        property.setHelp("Black Duck password.");
        property.setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.BLACKDUCK, DetectGroup.DEFAULT);
    });

    Property BLACKDUCK_PROXY_HOST = new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.host")).build(property -> {
    ...
    Property BLACKDUCK_PROXY_IGNORED_HOSTS = new PropertyBuilder<>(new StringListProperty("blackduck.proxy.ignored.hosts", emptyList())).build(property -> {
    ...
    Property BLACKDUCK_PROXY_NTLM_DOMAIN = new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.ntlm.domain")).build(property -> {
    ...
    Property BLACKDUCK_PROXY_NTLM_WORKSTATION = new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.ntlm.workstation")).build(property -> {
    ...
    Property BLACKDUCK_PROXY_PASSWORD = new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.password")).build(property -> {
    ...
    Property BLACKDUCK_PROXY_PORT = new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.port")).build(property -> {
    ...
    Property BLACKDUCK_PROXY_USERNAME = new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.username")).build(property -> {
    ...
    Property BLACKDUCK_TIMEOUT = new PropertyBuilder<>(new IntegerProperty("blackduck.timeout", 120)).build(property -> {
    ...
    Property BLACKDUCK_TRUST_CERT = new PropertyBuilder<>(new BooleanProperty("blackduck.trust.cert", false)).build(property -> {
    ...
    Property BLACKDUCK_URL = new PropertyBuilder<>(new NullableStringProperty("blackduck.url")).build(property -> {
        property.setInfo("Black Duck URL", "4.2.0")
        property.setHelp("URL of the Black Duck server.")
        property.setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.BLACKDUCK, DetectGroup.DEFAULT);
    });

    Property BLACKDUCK_USERNAME = new PropertyBuilder<>(new NullableStringProperty("blackduck.username")).build(property -> {
        property.setInfo("Black Duck Username", "4.2.0");
        property.setHelp("Black Duck username.");
        property.setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.BLACKDUCK, DetectGroup.DEFAULT);
    });

    Property DETECT_PARALLEL_PROCESSORS = new PropertyBuilder<>(new IntegerProperty("detect.parallel.processors", 1)).build(property -> {
    ...
    Property DETECT_BASH_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.bash.path")).build(property -> {
    ...
    Property DETECT_BAZEL_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.bazel.path")).build(property -> {
    ...
    Property DETECT_BAZEL_TARGET = new PropertyBuilder<>(new NullableStringProperty("detect.bazel.target")).build(property -> {
    ...
    Property DETECT_BAZEL_CQUERY_OPTIONS = new PropertyBuilder<>(new StringListProperty("detect.bazel.cquery.options", emptyList())).build(property -> {
    ...
    Property DETECT_BAZEL_DEPENDENCY_RULE = new PropertyBuilder<>(new EnumProperty("detect.bazel.dependency.type", WorkspaceRule.UNSPECIFIED, WorkspaceRule.class)).build(property -> {
    ...
    Property DETECT_BDIO_OUTPUT_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.bdio.output.path")).build(property -> {
    ...
    Property DETECT_BDIO2_ENABLED = new PropertyBuilder<>(new BooleanProperty("detect.bdio2.enabled", false)).build(property -> {
    ...
    Property DETECT_BINARY_SCAN_FILE = new PropertyBuilder<>(new NullablePathProperty("detect.binary.scan.file.path")).build(property -> {
    ...
    Property DETECT_BINARY_SCAN_FILE_NAME_PATTERNS = new PropertyBuilder<>(new StringListProperty("detect.binary.scan.file.name.patterns", emptyList())).build(property -> {
    ...
    Property DETECT_BITBAKE_BUILD_ENV_NAME = new PropertyBuilder<>(new StringProperty("detect.bitbake.build.env.name", "oe-init-build-env")).build(property -> {
    ...
    Property DETECT_BITBAKE_PACKAGE_NAMES = new PropertyBuilder<>(new StringListProperty("detect.bitbake.package.names", emptyList())).build(property -> {
    ...
    Property DETECT_BITBAKE_SOURCE_ARGUMENTS = new PropertyBuilder<>(new StringListProperty("detect.bitbake.source.arguments", emptyList())).build(property -> {
    ...
    Property DETECT_BITBAKE_SEARCH_DEPTH = new PropertyBuilder<>(new IntegerProperty("detect.bitbake.search.depth", 1)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_ARGUMENTS = new PropertyBuilder<>(new NullableStringProperty("detect.blackduck.signature.scanner.arguments")).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_COPYRIGHT_SEARCH = new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.copyright.search", false)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_DRY_RUN = new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.dry.run", false)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS = new PropertyBuilder<>(new StringListProperty("detect.blackduck.signature.scanner.exclusion.name.patterns", singletonList("node_modules"))).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERN_SEARCH_DEPTH = new PropertyBuilder<>(new IntegerProperty("detect.blackduck.signature.scanner.exclusion.pattern.search.depth", 4)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERNS = new PropertyBuilder<>(new StringListProperty("detect.blackduck.signature.scanner.exclusion.patterns", emptyList())).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_INDIVIDUAL_FILE_MATCHING = new PropertyBuilder<>(new ExtendedEnumProperty("detect.blackduck.signature.scanner.individual.file.matching", ExtendedEnumValue.ofExtendedValue(ExtendedIndividualFileMatchingMode.NONE), ExtendedIndividualFileMatchingMode.class, IndividualFileMatching.class)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_HOST_URL = new PropertyBuilder<>(new NullableStringProperty("detect.blackduck.signature.scanner.host.url")).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_LICENSE_SEARCH = new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.license.search", false)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_LOCAL_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.blackduck.signature.scanner.local.path")).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_MEMORY = new PropertyBuilder<>(new IntegerProperty("detect.blackduck.signature.scanner.memory", 4096)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.blackduck.signature.scanner.offline.local.path")).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_PATHS = new PropertyBuilder<>(new PathListProperty("detect.blackduck.signature.scanner.paths", emptyList())).build(property -> {
        property.setInfo("Signature Scanner Target Paths", "4.2.0");
        property.setHelp("These paths and only these paths will be scanned.");
        property.setGroups(DetectGroup.SIGNATURE_SCANNER, DetectGroup.GLOBAL);
    });

    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MATCHING = new PropertyBuilder<>(new ExtendedEnumProperty("detect.blackduck.signature.scanner.snippet.matching", ExtendedEnumValue.ofExtendedValue(ExtendedSnippetMode.NONE), ExtendedSnippetMode.class, SnippetMatching.class)).build(property -> {
    ...
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_UPLOAD_SOURCE_MODE = new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.upload.source.mode", false)).build(property -> {
    ...
    Property DETECT_BOM_AGGREGATE_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.bom.aggregate.name")).build(property -> {
    ...
    Property DETECT_BOM_AGGREGATE_REMEDIATION_MODE = new PropertyBuilder<>(new EnumProperty("detect.bom.aggregate.remediation.mode", AggregateMode.TRANSITIVE, AggregateMode.class)).build(property -> {
    ...
    Property DETECT_BUILDLESS = new PropertyBuilder<>(new BooleanProperty("detect.detector.buildless", false)).build(property -> {
    ...
    Property DETECT_CLEANUP = new PropertyBuilder<>(new BooleanProperty("detect.cleanup", true)).build(property -> {
    ...
    Property DETECT_CLONE_PROJECT_VERSION_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.clone.project.version.name")).build(property -> {
    ...
    Property DETECT_CLONE_PROJECT_VERSION_LATEST = new PropertyBuilder<>(new BooleanProperty("detect.clone.project.version.latest", false)).build(property -> {
    ...
    Property DETECT_CODE_LOCATION_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.code.location.name")).build(property -> {
    ...
    Property DETECT_CONDA_ENVIRONMENT_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.conda.environment.name")).build(property -> {
    ...
    Property DETECT_CONDA_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.conda.path")).build(property -> {
    ...
    Property DETECT_CPAN_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.cpan.path")).build(property -> {
    ...
    Property DETECT_CPANM_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.cpanm.path")).build(property -> {
        property.setInfo("cpanm Executable", "3.0.0");
        property.setHelp("The path to the cpanm executable.");
        property.setGroups(DetectGroup.CPAN, DetectGroup.GLOBAL);
    });

    Property DETECT_DEFAULT_PROJECT_VERSION_SCHEME = new PropertyBuilder<>(new EnumProperty("detect.default.project.version.scheme", DefaultVersionNameScheme.TEXT, DefaultVersionNameScheme.class)).build(property -> {
    ...
    Property DETECT_DEFAULT_PROJECT_VERSION_TEXT = new PropertyBuilder<>(new StringProperty("detect.default.project.version.text", "Default Detect Version")).build(property -> {
    ...
    Property DETECT_DEFAULT_PROJECT_VERSION_TIMEFORMAT = new PropertyBuilder<>(new StringProperty("detect.default.project.version.timeformat", "yyyy-MM-dd\'T\'HH:mm:ss.SSS")).build(property -> {
    ...
    Property DETECT_DETECTOR_SEARCH_DEPTH = new PropertyBuilder<>(new IntegerProperty("detect.detector.search.depth", 0)).build(property -> {
    ...
    Property DETECT_DETECTOR_SEARCH_CONTINUE = new PropertyBuilder<>(new BooleanProperty("detect.detector.search.continue", false)).build(property -> {
    ...
    Property DETECT_DETECTOR_SEARCH_EXCLUSION =  new PropertyBuilder<>(new StringListProperty("detect.detector.search.exclusion", emptyList())).build(property -> {
    ...
    Property DETECT_DETECTOR_SEARCH_EXCLUSION_PATTERNS = new PropertyBuilder<>(new StringListProperty("detect.detector.search.exclusion.patterns", emptyList())).build(property -> {
    ...
    Property DETECT_DETECTOR_SEARCH_EXCLUSION_FILES =  new PropertyBuilder<>(new StringListProperty("detect.detector.search.exclusion.files", emptyList())).build(property -> {
    ...
    Property DETECT_DETECTOR_SEARCH_EXCLUSION_DEFAULTS = new PropertyBuilder<>(new BooleanProperty("detect.detector.search.exclusion.defaults", true)).build(property -> {
        property.setInfo(" Detector File Exclusions", "6.0.0");
    ...
    Property DETECT_IGNORE_CONNECTION_FAILURES = new PropertyBuilder<>(new BooleanProperty("detect.ignore.connection.failures", false)).build(property -> {
    ...
    Property PHONEHOME_PASSTHROUGH = new PropertyBuilder<>(new PassthroughProperty("detect.phone.home.passthrough")).build(property -> {
    ...
    Property DOCKER_PASSTHROUGH = new PropertyBuilder<>(new PassthroughProperty("detect.docker.passthrough")).build(property -> {
    ...
    Property DETECT_DOCKER_IMAGE = new PropertyBuilder<>(new NullableStringProperty("detect.docker.image")).build(property -> {
    ...
    Property DETECT_DOCKER_IMAGE_ID = new PropertyBuilder<>(new NullableStringProperty("detect.docker.image.id")).build(property -> {
        property.setInfo("Docker Image ID", "6.1.0");
        property.setHelp("The Docker image ID to inspect.");
        property.setGroups(DetectGroup.DOCKER, DetectGroup.SOURCE_PATH);
    });

    Property DETECT_DOCKER_INSPECTOR_AIR_GAP_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.docker.inspector.air.gap.path")).build(property -> {
    ...
    Property DETECT_DOCKER_INSPECTOR_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.docker.inspector.path")).build(property -> {
    ...
    Property DETECT_DOCKER_INSPECTOR_VERSION = new PropertyBuilder<>(new NullableStringProperty("detect.docker.inspector.version")).build(property -> {
    ...
    Property DETECT_DOCKER_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.docker.path")).build(property -> {
        property.setInfo("Docker Executable", "3.0.0");
        property.setHelp("Path to the docker executable.");
        property.setGroups(DetectGroup.DOCKER, DetectGroup.GLOBAL);
    });

    Property DETECT_DOCKER_PATH_REQUIRED = new PropertyBuilder<>(new BooleanProperty("detect.docker.path.required", false)).build(property -> {
    ...
    Property DETECT_DOCKER_PLATFORM_TOP_LAYER_ID = new PropertyBuilder<>(new NullableStringProperty("detect.docker.platform.top.layer.id")).build(property -> {
    ...
    Property DETECT_DOCKER_TAR = new PropertyBuilder<>(new NullableStringProperty("detect.docker.tar")).build(property -> {
    ...
    Property DETECT_DOTNET_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.dotnet.path")).build(property -> {
    ...
    Property DETECT_EXCLUDED_DETECTOR_TYPES = new PropertyBuilder<>(new FilterableEnumListProperty("detect.excluded.detector.types", emptyList(), DetectorType.class)).build(property -> {
    ...
    Property DETECT_FORCE_SUCCESS = new PropertyBuilder<>(new BooleanProperty("detect.force.success", false)).build(property -> {
    ...
    Property DETECT_GIT_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.git.path")).build(property -> {
        property.setInfo("Git Executable", "5.5.0");
        property.setHelp("Path of the git executable");
        property.setGroups(DetectGroup.PATHS, DetectGroup.GLOBAL);
    });

    Property DETECT_GO_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.go.path")).build(property -> {
    ...
    Property DETECT_GRADLE_BUILD_COMMAND = new PropertyBuilder<>(new NullableStringProperty("detect.gradle.build.command")).build(property -> {
    ...
    Property DETECT_GRADLE_EXCLUDED_CONFIGURATIONS = new PropertyBuilder<>(new NullableStringProperty("detect.gradle.excluded.configurations")).build(property -> {
    ...
    Property DETECT_GRADLE_EXCLUDED_PROJECTS = new PropertyBuilder<>(new NullableStringProperty("detect.gradle.excluded.projects")).build(property -> {
    ...
    Property DETECT_GRADLE_INCLUDED_CONFIGURATIONS = new PropertyBuilder<>(new NullableStringProperty("detect.gradle.included.configurations")).build(property -> {
    ...
    Property DETECT_GRADLE_INCLUDED_PROJECTS = new PropertyBuilder<>(new NullableStringProperty("detect.gradle.included.projects")).build(property -> {
    ...
    Property DETECT_GRADLE_INSPECTOR_AIR_GAP_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.gradle.inspector.air.gap.path")).build(property -> {
    ...
    Property DETECT_GRADLE_INSPECTOR_VERSION = new PropertyBuilder<>(new NullableStringProperty("detect.gradle.inspector.version")).build(property -> {
    ...
    Property DETECT_GRADLE_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.gradle.path")).build(property -> {
    ...
    Property DETECT_HEX_REBAR3_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.hex.rebar3.path")).build(property -> {
    ...
    Property DETECT_INCLUDED_DETECTOR_TYPES = new PropertyBuilder<>(new FilterableEnumListProperty("detect.included.detector.types", emptyList(), DetectorType.class)).build(property -> {
    ...
    Property DETECT_JAVA_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.java.path")).build(property -> {
    ...
    Property DETECT_MAVEN_BUILD_COMMAND = new PropertyBuilder<>(new NullableStringProperty("detect.maven.build.command")).build(property -> {
    ...
    Property DETECT_MAVEN_EXCLUDED_MODULES = new PropertyBuilder<>(new NullableStringProperty("detect.maven.excluded.modules")).build(property -> {
    ...
    Property DETECT_MAVEN_INCLUDED_MODULES = new PropertyBuilder<>(new NullableStringProperty("detect.maven.included.modules")).build(property -> {
    ...
    Property DETECT_MAVEN_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.maven.path")).build(property -> {
    ...
    Property DETECT_MAVEN_INCLUDED_SCOPES = new PropertyBuilder<>(new NullableStringProperty("detect.maven.included.scopes")).build(property -> {
    ...
    Property DETECT_MAVEN_EXCLUDED_SCOPES = new PropertyBuilder<>(new NullableStringProperty("detect.maven.excluded.scopes")).build(property -> {
    ...
    Property DETECT_MAVEN_INCLUDE_PLUGINS = new PropertyBuilder<>(new BooleanProperty("detect.maven.include.plugins", false)).build(property -> {
    ...
    Property DETECT_NOTICES_REPORT = new PropertyBuilder<>(new BooleanProperty("detect.notices.report", false)).build(property -> {
    ...
    Property DETECT_NOTICES_REPORT_PATH = new PropertyBuilder<>(new PathProperty("detect.notices.report.path", new PathValue("."))).build(property -> {
    ...
    Property DETECT_NPM_ARGUMENTS = new PropertyBuilder<>(new NullableStringProperty("detect.npm.arguments")).build(property -> {
    ...
    Property DETECT_NPM_INCLUDE_DEV_DEPENDENCIES = new PropertyBuilder<>(new BooleanProperty("detect.npm.include.dev.dependencies", true)).build(property -> {
    ...
    Property DETECT_NPM_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.npm.path")).build(property -> {
    ...
    Property DETECT_NUGET_CONFIG_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.nuget.config.path")).build(property -> {
    ...
    Property DETECT_NUGET_EXCLUDED_MODULES = new PropertyBuilder<>(new NullableStringProperty("detect.nuget.excluded.modules")).build(property -> {
    ...
    Property DETECT_NUGET_IGNORE_FAILURE = new PropertyBuilder<>(new BooleanProperty("detect.nuget.ignore.failure", false)).build(property -> {
    ...
    Property DETECT_NUGET_INCLUDED_MODULES = new PropertyBuilder<>(new NullableStringProperty("detect.nuget.included.modules")).build(property -> {
    ...
    Property DETECT_NUGET_INSPECTOR_AIR_GAP_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.nuget.inspector.air.gap.path")).build(property -> {
    ...
    Property DETECT_NUGET_INSPECTOR_VERSION = new PropertyBuilder<>(new NullableStringProperty("detect.nuget.inspector.version")).build(property -> {
    ...
    Property DETECT_NUGET_PACKAGES_REPO_URL = new PropertyBuilder<>(new StringListProperty("detect.nuget.packages.repo.url", singletonList("https://api.nuget.org/v3/index.json"))).build(property -> {
    ...
    Property DETECT_OUTPUT_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.output.path")).build(property -> {
    ...
    Property DETECT_TOOLS_OUTPUT_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.tools.output.path")).build(property -> {
    ...
    Property DETECT_PACKAGIST_INCLUDE_DEV_DEPENDENCIES = new PropertyBuilder<>(new BooleanProperty("detect.packagist.include.dev.dependencies", true)).build(property -> {
    ...
    Property DETECT_PEAR_ONLY_REQUIRED_DEPS = new PropertyBuilder<>(new BooleanProperty("detect.pear.only.required.deps", false)).build(property -> {
    ...
    Property DETECT_PEAR_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.pear.path")).build(property -> {
    ...
    Property DETECT_PIP_PROJECT_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.pip.project.name")).build(property -> {
    ...
    Property DETECT_PIP_PROJECT_VERSION_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.pip.project.version.name")).build(property -> {
    ...
    Property DETECT_PIP_REQUIREMENTS_PATH = new PropertyBuilder<>(new PathListProperty("detect.pip.requirements.path", emptyList())).build(property -> {
        property.setInfo("PIP Requirements Path", "3.0.0");
        property.setHelp("A comma-separated list of paths to requirements.txt files.");
        property.setGroups(DetectGroup.PIP, DetectGroup.SOURCE_SCAN);
    });

    Property DETECT_PIP_ONLY_PROJECT_TREE = new PropertyBuilder<>(new BooleanProperty("detect.pip.only.project.tree", false)).build(property -> {
    ...
    Property DETECT_PIPENV_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.pipenv.path")).build(property -> {
    ...
    Property DETECT_SWIFT_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.swift.path")).build(property -> {
        property.setInfo("Swift Executable", "6.0.0");
        property.setHelp("Path of the swift executable.");
        property.setGroups(DetectGroup.PATHS, DetectGroup.GLOBAL);
    });

    Property DETECT_POLICY_CHECK_FAIL_ON_SEVERITIES = new PropertyBuilder<>(new FilterableEnumListProperty("detect.policy.check.fail.on.severities", FilterableEnumUtils.noneList(), PolicyRuleSeverityType.class)).build(property -> {
    ...
    Property DETECT_PROJECT_APPLICATION_ID = new PropertyBuilder<>(new NullableStringProperty("detect.project.application.id")).build(property -> {
    ...
    Property DETECT_CUSTOM_FIELDS_PROJECT = new PropertyBuilder<>(new NullableStringProperty("detect.custom.fields.project")).build(property -> {
    ...
    Property DETECT_CUSTOM_FIELDS_VERSION = new PropertyBuilder<>(new NullableStringProperty("detect.custom.fields.version")).build(property -> {
        property.setInfo("Custom Fields", "5.6.0");
    ...
    Property DETECT_PROJECT_CLONE_CATEGORIES = new PropertyBuilder<>(new EnumListProperty("detect.project.clone.categories", Arrays.asList(ProjectCloneCategoriesType.COMPONENT_DATA, ProjectCloneCategoriesType.VULN_DATA), ProjectCloneCategoriesType.class)).build(property -> {
    ...
    Property DETECT_PROJECT_CODELOCATION_PREFIX = new PropertyBuilder<>(new NullableStringProperty("detect.project.codelocation.prefix")).build(property -> {
    ...
    Property DETECT_PROJECT_CODELOCATION_SUFFIX = new PropertyBuilder<>(new NullableStringProperty("detect.project.codelocation.suffix")).build(property -> {
    ...
    Property DETECT_PROJECT_CODELOCATION_UNMAP = new PropertyBuilder<>(new BooleanProperty("detect.project.codelocation.unmap", false)).build(property -> {
    ...
    Property DETECT_PROJECT_DESCRIPTION = new PropertyBuilder<>(new NullableStringProperty("detect.project.description")).build(property -> {
    ...
    Property DETECT_PROJECT_USER_GROUPS = new PropertyBuilder<>(new StringListProperty("detect.project.user.groups", emptyList())).build(property -> {
    ...
    Property DETECT_PROJECT_TAGS = new PropertyBuilder<>(new StringListProperty("detect.project.tags", emptyList())).build(property -> {
    ...
    Property DETECT_PROJECT_DETECTOR = new PropertyBuilder<>(new NullableStringProperty("detect.project.detector")).build(property -> {
    ...
    Property DETECT_PROJECT_LEVEL_ADJUSTMENTS = new PropertyBuilder<>(new BooleanProperty("detect.project.level.adjustments", true)).build(property -> {
    ...
    Property DETECT_PROJECT_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.project.name")).build(property -> {
    ...
    Property DETECT_PARENT_PROJECT_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.parent.project.name")).build(property -> {
    ...
    Property DETECT_PARENT_PROJECT_VERSION_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.parent.project.version.name")).build(property -> {
    ...
    Property DETECT_PROJECT_TIER = new PropertyBuilder<>(new NullableIntegerProperty("detect.project.tier")).build(property -> {
    ...
    Property DETECT_PROJECT_TOOL = new PropertyBuilder<>(new EnumListProperty("detect.project.tool", Arrays.asList(DetectTool.DOCKER, DetectTool.DETECTOR, DetectTool.BAZEL), DetectTool.class)).build(property -> {
    ...
    Property DETECT_PROJECT_VERSION_DISTRIBUTION = new PropertyBuilder<>(new EnumProperty("detect.project.version.distribution", LicenseFamilyLicenseFamilyRiskRulesReleaseDistributionType.EXTERNAL, LicenseFamilyLicenseFamilyRiskRulesReleaseDistributionType.class)).build(property -> {
    ...
    Property DETECT_PROJECT_VERSION_NAME = new PropertyBuilder<>(new NullableStringProperty("detect.project.version.name")).build(property -> {
    ...
    Property DETECT_PROJECT_VERSION_NICKNAME = new PropertyBuilder<>(new NullableStringProperty("detect.project.version.nickname")).build(property -> {
    ...
    Property DETECT_PROJECT_VERSION_NOTES = new PropertyBuilder<>(new NullableStringProperty("detect.project.version.notes")).build(property -> {
    ...
    Property DETECT_PROJECT_VERSION_PHASE = new PropertyBuilder<>(new EnumProperty("detect.project.version.phase", ProjectVersionPhaseType.DEVELOPMENT, ProjectVersionPhaseType.class)).build(property -> {
        property.setInfo("Version Phase", "3.0.0");
        property.setHelp("An override for the Project Version phase.");
        property.setGroups(DetectGroup.PROJECT, DetectGroup.PROJECT_SETTING);
    });

    Property DETECT_PROJECT_VERSION_UPDATE = new PropertyBuilder<>(new BooleanProperty("detect.project.version.update", false)).build(property -> {
    ...
    Property DETECT_PYTHON_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.python.path")).build(property -> {
    ...
    Property DETECT_PYTHON_PYTHON3 = new PropertyBuilder<>(new BooleanProperty("detect.python.python3", false)).build(property -> {
        property.setInfo("Use Python3", "3.0.0");
        property.setHelp("If true will use Python 3 if available on class path.");
        property.setGroups(DetectGroup.PYTHON, DetectGroup.GLOBAL);
    });

    Property DETECT_REPORT_TIMEOUT = new PropertyBuilder<>(new LongProperty("detect.report.timeout", new Long(300))).build(property -> {
    ...
    Property DETECT_REQUIRED_DETECTOR_TYPES = new PropertyBuilder<>(new EnumListProperty("detect.required.detector.types", emptyList(), DetectorType.class)).build(property -> {
    ...
    Property DETECT_RESOLVE_TILDE_IN_PATHS = new PropertyBuilder<>(new BooleanProperty("detect.resolve.tilde.in.paths", true)).build(property -> {
    ...
    Property DETECT_RISK_REPORT_PDF = new PropertyBuilder<>(new BooleanProperty("detect.risk.report.pdf", false)).build(property -> {
    ...
    Property DETECT_RISK_REPORT_PDF_PATH = new PropertyBuilder<>(new PathProperty("detect.risk.report.pdf.path", new PathValue("."))).build(property -> {
    ...
    Property DETECT_RUBY_INCLUDE_RUNTIME_DEPENDENCIES = new PropertyBuilder<>(new BooleanProperty("detect.ruby.include.runtime.dependencies", true)).build(property -> {
    ...
    Property DETECT_RUBY_INCLUDE_DEV_DEPENDENCIES = new PropertyBuilder<>(new BooleanProperty("detect.ruby.include.dev.dependencies", false)).build(property -> {
    ...
    Property DETECT_SBT_EXCLUDED_CONFIGURATIONS = new PropertyBuilder<>(new NullableStringProperty("detect.sbt.excluded.configurations")).build(property -> {
    ...
    Property DETECT_SBT_INCLUDED_CONFIGURATIONS = new PropertyBuilder<>(new NullableStringProperty("detect.sbt.included.configurations")).build(property -> {
    ...
    Property DETECT_SBT_REPORT_DEPTH = new PropertyBuilder<>(new IntegerProperty("detect.sbt.report.search.depth", 3)).build(property -> {
    ...
    Property DETECT_SCAN_OUTPUT_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.scan.output.path")).build(property -> {
    ...
    Property DETECT_SOURCE_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.source.path")).build(property -> {
    ...
    Property DETECT_TEST_CONNECTION = new PropertyBuilder<>(new BooleanProperty("detect.test.connection", false)).build(property -> {
    ...
    Property DETECT_TOOLS = new PropertyBuilder<>(new FilterableEnumListProperty("detect.tools", emptyList(), DetectTool.class)).build(property -> {
    ...
    Property DETECT_TOOLS_EXCLUDED = new PropertyBuilder<>(new FilterableEnumListProperty("detect.tools.excluded", emptyList(), DetectTool.class)).build(property -> {
    ...
    Property DETECT_YARN_PROD_ONLY = new PropertyBuilder<>(new BooleanProperty("detect.yarn.prod.only", false)).build(property -> {
    ...
    Property LOGGING_LEVEL_COM_SYNOPSYS_INTEGRATION = new PropertyBuilder<>(new EnumProperty("logging.level.com.synopsys.integration", LogLevel.INFO, LogLevel.class)).build(property -> {
    ...
    Property LOGGING_LEVEL_DETECT = new PropertyBuilder<>(new EnumProperty("logging.level.detect", LogLevel.INFO, LogLevel.class)).build(property -> {
    ...
    Property DETECT_WAIT_FOR_RESULTS = new PropertyBuilder<>(new BooleanProperty("detect.wait.for.results", false)).build(property -> {
    ...
    Property DETECT_LERNA_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.lerna.path")).build(property -> {
    ...
    Property DETECT_LERNA_INCLUDE_PRIVATE = new PropertyBuilder<>(new BooleanProperty("detect.lerna.include.private", false)).build(property -> {
    ...
    final String DEPRECATED_PROPERTY_MESSAGE = "This property is deprecated.";
    String POLARIS_CLI_DEPRECATION_MESSAGE = "This property is being removed. Detect will no longer invoke the Polaris CLI.";

    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BITBAKE_REFERENCE_IMPL = new PropertyBuilder<>(new StringProperty("detect.bitbake.reference.impl", "-poky-linux")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_API_TIMEOUT = new PropertyBuilder<>(new LongProperty("detect.api.timeout", new Long(300000))).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_URL = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.url")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_TIMEOUT = new PropertyBuilder<>(new IntegerProperty("blackduck.hub.timeout", 120)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_USERNAME = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.username")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PASSWORD = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.password")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_API_TOKEN = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.api.token")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PROXY_HOST = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.host")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PROXY_PORT = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.port")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PROXY_USERNAME = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.username")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PROXY_PASSWORD = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.password")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PROXY_NTLM_DOMAIN = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.ntlm.domain")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PROXY_IGNORED_HOSTS = new PropertyBuilder<>(new StringListProperty("blackduck.hub.proxy.ignored.hosts", emptyList())).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_PROXY_NTLM_WORKSTATION = new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.ntlm.workstation")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_TRUST_CERT = new PropertyBuilder<>(new BooleanProperty("blackduck.hub.trust.cert", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property BLACKDUCK_HUB_OFFLINE_MODE = new PropertyBuilder<>(new BooleanProperty("blackduck.hub.offline.mode", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_DISABLE_WITHOUT_HUB = new PropertyBuilder<>(new BooleanProperty("detect.disable.without.hub", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_DISABLE_WITHOUT_BLACKDUCK = new PropertyBuilder<>(new BooleanProperty("detect.disable.without.blackduck", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_SUPPRESS_CONFIGURATION_OUTPUT = new PropertyBuilder<>(new BooleanProperty("detect.suppress.configuration.output", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_SUPPRESS_RESULTS_OUTPUT = new PropertyBuilder<>(new BooleanProperty("detect.suppress.results.output", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_EXCLUDED_BOM_TOOL_TYPES = new PropertyBuilder<>(new NullableStringProperty("detect.excluded.bom.tool.types")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BOM_TOOL_SEARCH_EXCLUSION_DEFAULTS = new PropertyBuilder<>(new BooleanProperty("detect.bom.tool.search.exclusion.defaults", true)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BOM_TOOL_SEARCH_EXCLUSION = new PropertyBuilder<>(new StringListProperty("detect.bom.tool.search.exclusion", emptyList())).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_INCLUDED_BOM_TOOL_TYPES = new PropertyBuilder<>(new NullableStringProperty("detect.included.bom.tool.types")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_PROJECT_BOM_TOOL = new PropertyBuilder<>(new NullableStringProperty("detect.project.bom.tool")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BOM_TOOL_SEARCH_DEPTH = new PropertyBuilder<>(new IntegerProperty("detect.bom.tool.search.depth", 0)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_REQUIRED_BOM_TOOL_TYPES = new PropertyBuilder<>(new NullableStringProperty("detect.required.bom.tool.types")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BOM_TOOL_SEARCH_CONTINUE = new PropertyBuilder<>(new BooleanProperty("detect.bom.tool.search.continue", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_GRADLE_INSPECTOR_REPOSITORY_URL = new PropertyBuilder<>(new NullableStringProperty("detect.gradle.inspector.repository.url")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_NUGET_INSPECTOR_NAME = new PropertyBuilder<>(new StringProperty("detect.nuget.inspector.name", "IntegrationNugetInspector")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_NUGET_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.nuget.path")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_DRY_RUN = new PropertyBuilder<>(new BooleanProperty("detect.hub.signature.scanner.dry.run", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_PATTERNS = new PropertyBuilder<>(new StringListProperty("detect.hub.signature.scanner.exclusion.patterns", emptyList())).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_PATHS = new PropertyBuilder<>(new PathListProperty("detect.hub.signature.scanner.paths", emptyList())).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS = new PropertyBuilder<>(new StringListProperty("detect.hub.signature.scanner.exclusion.name.patterns", Arrays.asList("node_modules"))).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_MEMORY = new PropertyBuilder<>(new IntegerProperty("detect.hub.signature.scanner.memory", 4096)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_DISABLED =  new PropertyBuilder<>(new BooleanProperty("detect.hub.signature.scanner.disabled", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_DISABLED = new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.disabled", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.hub.signature.scanner.offline.local.path")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_LOCAL_PATH = new PropertyBuilder<>(new NullablePathProperty("detect.hub.signature.scanner.local.path")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_HOST_URL = new PropertyBuilder<>(new NullableStringProperty("detect.hub.signature.scanner.host.url")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_PARALLEL_PROCESSORS = new PropertyBuilder<>(new IntegerProperty("detect.blackduck.signature.scanner.parallel.processors", 1)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_PARALLEL_PROCESSORS = new PropertyBuilder<>(new IntegerProperty("detect.hub.signature.scanner.parallel.processors", 1)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_HUB_SIGNATURE_SCANNER_ARGUMENTS = new PropertyBuilder<>(new NullableStringProperty("detect.hub.signature.scanner.arguments")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_SWIP_ENABLED = new PropertyBuilder<>(new BooleanProperty("detect.polaris.enabled", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property LOGGING_LEVEL_COM_BLACKDUCKSOFTWARE_INTEGRATION = new PropertyBuilder<>(new EnumProperty("logging.level.com.blackducksoftware.integration", LogLevel.INFO, LogLevel::class.java)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_MAVEN_SCOPE = new PropertyBuilder<>(new NullableStringProperty("detect.maven.scope")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MODE = new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.snippet.mode", false)).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property POLARIS_URL = new PropertyBuilder<>(new NullableStringProperty("polaris.url")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property POLARIS_ACCESS_TOKEN = new PropertyBuilder<>(new NullableStringProperty("polaris.access.token")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property POLARIS_ARGUMENTS = new PropertyBuilder<>(new NullableStringProperty("polaris.arguments")).build(property -> {
    ...
    @Deprecated(DEPRECATED_PROPERTY_MESSAGE)
    Property POLARIS_COMMAND = new PropertyBuilder<>(new NullableStringProperty("polaris.command")).build(property -> {
