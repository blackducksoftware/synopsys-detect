...
class DetectProperties {
    companion object {
        ...
        const val DETECT_POLARIS_CLI_MESSAGE = "This property is being removed. Detect will no longer invoke the Polaris CLI."
        ...
        val POLARIS_URL = NullableStringProperty("polaris.url").apply {
            ...
            setDeprecated(DETECT_POLARIS_CLI_MESSAGE, DetectMajorVersion.SEVEN, DetectMajorVersion.EIGHT)
        }
