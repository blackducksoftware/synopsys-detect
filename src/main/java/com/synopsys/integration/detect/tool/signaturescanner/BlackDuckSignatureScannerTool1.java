...
public class BlackDuckSignatureScannerTool1 {
    private Logger logger = LoggerFactory.getLogger(BlackDuckSignatureScannerTool1.class);
    ...
    public BlackDuckSignatureScannerTool1(BlackDuckSignatureScannerOptions signatureScannerOptions, DetectContext detectContext, DirectoryManager directoryManager, CodeLocationNameManager codeLocationNameManager, ConnectionFactory connectionFactory) {
    ...
    public SignatureScannerToolResult runScanTool(BlackDuckRunData blackDuckRunData, NameVersion projectNameVersion, Optional<File> dockerTar) throws DetectUserFriendlyException {
        Optional<BlackDuckServerConfig> blackDuckServerConfig = getBlackDuckServerConfigFromRunData(blackDuckRunData);
        ...
        try {
            ...
            return runScanner(blackDuckSignatureScanner, blackDuckServerConfig.orElse(null), blackDuckRunData.getBlackDuckServicesFactory().orElse(null), projectNameVersion, installDirectory, dockerTar.orElse(null));
    ...
    private Optional<BlackDuckServerConfig> getBlackDuckServerConfigFromRunData(BlackDuckRunData blackDuckRunData) {
    ...
    private SignatureScannerToolResult runScanner(BlackDuckSignatureScanner blackDuckSignatureScanner, @Nullable BlackDuckServerConfig blackDuckServerConfig, @Nullable BlackDuckServicesFactory blackDuckServicesFactory, NameVersion projectNameVersion, File installDirectory, @Nullable File dockerTar)
