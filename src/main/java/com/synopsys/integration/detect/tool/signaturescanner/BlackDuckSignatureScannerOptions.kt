...
class BlackDuckSignatureScannerOptions(
        ...
        val onlineLocalScannerInstallPath: Path?,
        val userProvidedScannerInstallUrl: String?,
        val scanMemory: Int,
        val parallelProcessors: Int,
        val dryRun: Boolean,
        val snippetMatching: SnippetMatching?,
        val uploadSource: Boolean,
        val codeLocationPrefix: String?,
        val codeLocationSuffix: String?,
        val additionalArguments: String?,
        val maxDepth: Int,
        val individualFileMatching: IndividualFileMatching?,
