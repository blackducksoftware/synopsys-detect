...
public class DetectableFactoryDetectorRuleSetBuilder extends DetectorRuleSetBuilder {
    ...
    public <T extends Detectable> DetectorRuleBuilder addDetector(final DetectorType type, final String name, Class<T> detectableClass) {
        return addDetector(type, name, detectableClass, environment -> detectableFactory.createDetectable(detectableClass, environment));
    }
}
