...
public class DetectorRuleFactory {
    ...
    private DetectorRuleSet createRules(DetectDetectableFactory detectableFactory) {
        ...
        DetectorRule<?> xcodeRule = ruleSet.addDetector(DetectorType.XCODE, "Xcode Swift", XcodeSwiftDetectable.class, detectableFactory::createXcodeSwiftDetectable).defaults().selfNestable().build();
