...
//                    System.out.println("This POM has no properties section.");
                }
                ///////////////////////////////////////////////////////
                // PARSE DEPENDENCIES
                int count = 0;
                ...
                for (int i = 0; i < dependencies.getLength(); i++) {
                    ...
                    try {
                        ...
                        if (childNodes.item(5).getNodeName() == "version") {
                            ...
                            mdl.setPomFilePath(filepath);
                        } else {
//                            System.out.println("\n***EDGE CASE ENCOUNTERED: NO VERSION PRESENT -->" + depExternalId.getGAV() + "\n");
...
//                System.out.println("Done parsing " + filepath + " for dependencies.");
                ///////////////////////////////////////////////////////

            } catch(ParserConfigurationException e){
                throw new RuntimeException("Can't create SAX parser / DOM builder.", e);
            } catch (Exception e) {
//                System.out.println("problem creating xml doc to parse");
            }

        } catch (FileNotFoundException e) {
//            System.out.println("Could not find pom file: " + e);
        }
        catch (Exception e) {
...
//            System.out.println("Could not resolve properties variable");
            return new MavenProperty("unknown property", 123);
        }
    }
