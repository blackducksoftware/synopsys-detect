...
public class FontLoaderTest {
    ...
    public void loadsCJKFont() {
        final DetectFontLoader fontLoader = new DetectFontLoader();
        final PDFont font = fontLoader.loadFont(new PDDocument());
    ...
    public void loadsCJKBoldFont() {
        final DetectFontLoader fontLoader = new DetectFontLoader();
        final PDFont font = fontLoader.loadBoldFont(new PDDocument());
        Assertions.assertTrue(font.getName().contains("CJK"));
    }
}
