...
public class ProjectInspectorTests {
    ...
    void dotnetProjectInspector() throws IOException, InterruptedException {
        test = new DetectDockerTestRunner("detect-dotnet-project-inspector", "detect-dotnet-five:1.0.1");
    ...
    void gradleProjectInspector() throws IOException, InterruptedException {
        test = new DetectDockerTestRunner("detect-gradle-project-inspector", "gradle-simple:1.0.0");
    ...
    void mavenProjectInspectorLegacyIsTheDefault() throws IOException, InterruptedException {
        test = new DetectDockerTestRunner("detect-maven-project-inspector-legacy", "maven-simple:1.0.0");
    ...
    void mavenProjectInspector() throws IOException, InterruptedException {
        test = new DetectDockerTestRunner("detect-maven-project-inspector", "maven-simple:1.0.0");
        test.withImageProvider(BuildDockerImageProvider.forDockerfilResourceNamed("SimpleMaven.dockerfile"));
