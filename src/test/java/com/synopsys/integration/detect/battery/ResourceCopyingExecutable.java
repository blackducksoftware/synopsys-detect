...
public class ResourceCopyingExecutable extends TypingExecutable {
    private final List<String> toType;

    protected ResourceCopyingExecutable(final DetectProperty detectProperty, final List<String> toType) {
