...
public class BitbakeBattery {
    ...
    void testIncludeAll() {
        ...
        test.executableFromResourceFiles(DetectProperties.DETECT_BASH_PATH.getProperty(), "pwd.xout", "environment.xout", "bitbake-layers-show-recipes.xout", "bitbake-g.xout");
