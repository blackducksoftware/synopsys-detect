...
public class Dotnet5Test {
    ...
    void detectUsesDotnet5() throws IOException {
        try (DetectDockerTestRunner test = new DetectDockerTestRunner("detect-dotnet-five", "detect-dotnet-five:1.0.1")) {
            ...
            dockerAssertions.logContains("https://sig-repo.synopsys.com/artifactory/bds-integrations-release/com/synopsys/integration/detect-nuget-inspector"); // Verify we are using the EXTERNAL artifactory to download the inspector.
        }
    }
