...
public class ResourceTypingExecutableCreator extends TypingExecutableCreator {
    ...
    @Override
    public List<String> getFilePaths(File mockDirectory, AtomicInteger commandCount) throws IOException {
        ...
        for (String resource : toType) {
            try (InputStream commandText = BatteryFiles.asInputStream(resource)) {
                ...
                File commandTextFile = new File(mockDirectory, "cmd-" + commandCount.getAndIncrement() + ".txt");
