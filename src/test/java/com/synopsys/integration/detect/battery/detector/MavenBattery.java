...
public class MavenBattery {
    ...
    void mavenFromProperty() {
        final DetectorBatteryTestRunner test = new DetectorBatteryTestRunner("maven-property", "maven-cli");
    ...
    void mavenFromSourceFile() {
        final DetectorBatteryTestRunner test = new DetectorBatteryTestRunner("maven-wrapper", "maven-cli");
