...
public class DetectConfigurationFactoryTests {
    ...
    public void parallelProcessorsDefaultsToOne() {
        ...
        final Integer defaultValue =  DetectProperties.DETECT_PARALLEL_PROCESSORS().getDefaultValue();
    ...
    public void parallelProcessorsPrefersProperty() {
        final DetectConfigurationFactory factory = factoryOf(Pair.of(DetectProperties.DETECT_PARALLEL_PROCESSORS(), "3"));
