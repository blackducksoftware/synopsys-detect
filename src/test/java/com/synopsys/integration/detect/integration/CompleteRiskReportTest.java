...
public class CompleteRiskReportTest extends BlackDuckIntegrationTest {
    ...
    public void testRiskReportIsPopulated(boolean includePath) throws Exception {
        ...
        File reportPdf = reportService.createReportPdfFile(reportDirectory, projectVersionWrapper.getProjectView(), projectVersionWrapper.getProjectVersionView());
        ...
        FileUtils.deleteQuietly(reportPdf);
    }
