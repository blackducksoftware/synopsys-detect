...
class ProductDeciderTest {
    ...
    public void shouldRunPolarisWhenConfigValid() {
        ...
        PolarisDecision polarisDecision = new ProductDecider().determinePolaris(detectConfigurationFactory, userHome, detectToolFilter, runOptions, blackDuckRunOptions);
