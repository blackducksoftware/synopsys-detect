...
\--- com.synopsys.integration:integration-common:24.0.0 (n)
...
+--- project common (n)
+--- org.tomlj:tomlj:1.0.0 (n)
+--- org.codehaus.groovy:groovy-astbuilder:3.0.7 (n)
+--- com.moandjiezana.toml:toml4j:0.7.1 (n)
+--- com.paypal.digraph:digraph-parser:1.0 (n)
+--- org.freemarker:freemarker:2.3.26-incubating (n)
+--- com.synopsys.integration:integration-bdio:21.2.0 (n)
\--- com.synopsys.integration:integration-rest:6.0.1 (n)
...
projectDirectory:${sourcePath?replace("\\", "/")}/detectable
