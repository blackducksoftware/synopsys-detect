...
public class Terms {
    ...
    public Terms() {
        ...
        termMap.put("binary_repo_url_project", "https://repo.blackduck.com/bds-integrations-release/com/blackduck/integration/synopsys-detect");
        termMap.put("binary_repo_ui_url_project", "https://repo.synopsys.com/bds-integrations-release/com/synopsys/integration/synopsys-detect");
