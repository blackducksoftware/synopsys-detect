package com.blackduck.integration.detectable.detectables.git.functional;

import static com.blackduck.integration.detectable.detectables.git.cli.GitCliExtractor.EXTRACTION_METADATA_KEY;
