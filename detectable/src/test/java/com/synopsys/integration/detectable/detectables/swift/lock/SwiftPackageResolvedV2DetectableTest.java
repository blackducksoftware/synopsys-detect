...
class SwiftPackageResolvedV2DetectableTest extends DetectableFunctionalTest {
    protected SwiftPackageResolvedV2DetectableTest() throws IOException {
    ...
    public void setup() throws IOException {
        ...
        addFileFromResources(Paths.get("Package.resolved"), "/swift/v2/Package.resolved");
    }
