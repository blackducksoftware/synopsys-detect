...
public class CompileCommandParserTest {
    ...
    public void testGetCompilerCmd() {
        final CompileCommand sampleCommand = new CompileCommand();
        ...
        final List<String> compilerCommand = compileCommandParser.parseCommand(sampleCommand, Collections.emptyMap());
    ...
    public void testGetCompilerArgs() {
        ...
        final CompileCommandParser compileCommandParser = new CompileCommandParser();
        final List<String> result = compileCommandParser.parseCommand(sampleCommand, optionOverrides);

        for (final String part : result) {
    ...
    public void testFullCompileCommand() {
        final CompileCommand command = new CompileCommand();
        ...
        final CompileCommandParser compileCommandParser = new CompileCommandParser();
        final List<String> result = compileCommandParser.parseCommand(command, Collections.emptyMap());
