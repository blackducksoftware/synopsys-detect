package com.synopsys.integration.detectable.detectables.maven.unit.cli;
...
public class MavenCliExtractorOptionsTest {
    ...
    public void testBuildCliArguments(String mavenBuildCommand, List<String> expected) {
        ...
        MavenCliExtractorOptions options = new MavenCliExtractorOptions(mavenBuildCommand, null, null, null, null, null);
        assertEquals(
            expected,
