...
public class ComposerLockDetectableTest {
    ...
    public void testApplicable() {
        ...
        final ComposerLockDetectable detectable = new ComposerLockDetectable(environment, fileFinder, composerLockExtractor, new ComposerLockDetectableOptions(true));
