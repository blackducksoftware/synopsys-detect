...
public class DetectableFactory {
    ...
    public Conan1CliDetectable createConanCliDetectable(DetectableEnvironment environment, com.blackduck.integration.detectable.detectables.conan.cli.ConanResolver conanResolver, ConanCliOptions conanCliOptions) {
