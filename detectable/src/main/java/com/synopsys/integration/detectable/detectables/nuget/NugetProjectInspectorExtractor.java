...
public class NugetProjectInspectorExtractor {
    ...
    private final NugetProjectInspectorParser nugetProjectInspectorParser;

    public NugetProjectInspectorExtractor(DetectableExecutableRunner executableRunner, NugetProjectInspectorParser nugetProjectInspectorParser) {
        this.executableRunner = executableRunner;
        this.nugetProjectInspectorParser = nugetProjectInspectorParser;
    }
    ...
    public Extraction extract(File targetDirectory, File outputDirectory, ExecutableTarget inspector, NugetInspectorOptions nugetInspectorOptions) throws ExecutableFailedException {
        ...
        try {
            ...
            List<CodeLocation> codeLocations = nugetProjectInspectorParser.parse(outputContents);
