 ...
 * under the License.
 */
package com.synopsys.integration.detectable.detectable.inspector.impl.artifactory;
...
import com.synopsys.integration.detectable.detectable.http.HttpClientFactory;
...
public class ArtifactResolver {
    ...
    public ArtifactResolver(final HttpClientFactory httpClientFactory, final Gson gson) {
     ...
     */
    public Optional<String> resolveArtifactVersion(final String artifactoryBaseUrl, final String repositoryUrl, final String propertyKey, final String overrideVersion) throws IntegrationException, IOException {
    ...
    private Optional<String> downloadProperty(String apiUrl, String propertyKey) throws IntegrationException, IOException {
        ...
        final IntHttpClient restConnection = httpClientFactory.createHttpClient(propertyUrl);
    ...
    public File downloadArtifact(File target, String source) throws IntegrationException, IOException {
        ...
        final IntHttpClient restConnection = httpClientFactory.createHttpClient(source);
