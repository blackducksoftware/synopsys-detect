...
public class PnpmLockYamlParser {
    ...
    public CodeLocation parse(File pnpmLockYamlFile, boolean includeDevDependencies, boolean includeOptionalDependencies, @Nullable NameVersion projectNameVersion) throws IOException, IntegrationException {
        ...
        return pnpmTransformer.generateCodeLocation(pnpmLockYaml, includeDevDependencies, includeOptionalDependencies, projectNameVersion);
    }
}
