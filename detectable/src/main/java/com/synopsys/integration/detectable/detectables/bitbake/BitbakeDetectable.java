...
@DetectableInfo(group = "Bitbake", name = "Bitbake", language = "various", forge = "YOCTO", requirementsMarkdown = "Properties: Package names <br /><br /> File: build env script.<br /><br /> Executable: bash")
