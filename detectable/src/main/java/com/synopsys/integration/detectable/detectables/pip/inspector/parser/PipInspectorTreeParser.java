...
public class PipInspectorTreeParser {
    ...
    public Optional<NameVersionCodeLocation> parse(List<String> pipInspectorOutputAsList, String sourcePath) {
        ...
        for (String line : pipInspectorOutputAsList) {
            ...
            if (StringUtils.isEmpty(trimmedLine) || !trimmedLine.contains(SEPARATOR) || trimmedLine.startsWith(UNKNOWN_REQUIREMENTS_PREFIX) || trimmedLine.startsWith(
                UNPARSEABLE_REQUIREMENTS_PREFIX) || trimmedLine.startsWith(
