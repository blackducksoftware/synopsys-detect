...
public class MavenCliDetectable extends Detectable {
    ...
    public MavenCliDetectable(final DetectableEnvironment environment, final FileFinder fileFinder, final MavenExecutableFinder mavenExecutableFinder, final MavenCliExtractor mavenCliExtractor) {
