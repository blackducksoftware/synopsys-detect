...
public class GoReplacementManager {
    ...
    public GoReplacementManager(List<GoListAllData> allModules, ExternalIdFactory externalIdFactory) {
        this.allModules = allModules;
        this.externalIdFactory = externalIdFactory;
    }

    public Dependency getReplacementForModule(String moduleName) {
        String replacementName = getPathForModule(moduleName).orElse(moduleName);
        String replacementVersion = getVersionForModule(moduleName).orElse(null);
        return new Dependency(replacementName, replacementVersion, externalIdFactory.createNameVersionExternalId(Forge.GOLANG, moduleName, replacementVersion));
    }
