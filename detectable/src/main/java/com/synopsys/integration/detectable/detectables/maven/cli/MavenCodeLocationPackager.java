...
public class MavenCodeLocationPackager {
    ...
    public List<MavenParseResult> extractCodeLocations(String sourcePath, String mavenOutputText, List<String> excludedScopes, List<String> includedScopes, String excludedModules, String includedModules) {
        ...
        ExcludedIncludedWildcardFilter scopeFilter = new ExcludedIncludedWildcardFilter(StringUtils.joinWith(",", excludedScopes.toArray()), StringUtils.joinWith(",", includedScopes.toArray())); // TODO: Replace when INTCMN-469 is completed.
