...
@DetectableInfo(group = "PACKAGIST", name = "Packagist composer lock", language = "PHP", forge = "Packagist.org", requirementsMarkdown = "Files: TBD. <br /><br /> Executables: TBD on PATH.")
