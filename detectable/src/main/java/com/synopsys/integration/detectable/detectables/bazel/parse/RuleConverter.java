...
public class RuleConverter {
    ...
    //    /query/rule[@class='jvm_import']/list[@name='tags']/string
    ///query/rule[@class='jvm_import']/string[@name='artifact'], targetAttributeName: value
    public static final String XPATH_QUERY_FOR_ARTIFACT = "/query/rule[@class='jvm_import']/list[@name='tags']/string";
...
//        dependencyToBazelExternalIdTransforms.add(new SearchReplacePattern("^", "//external:"));
        ...
        final BazelExternalIdExtractionFullRule fullRule = new BazelExternalIdExtractionFullRule(
                targetDependenciesQueryBazelCmdArguments,
